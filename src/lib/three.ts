...
import type {ArrowHelper} from 'three/src/helpers/ArrowHelper'
...
export const trackCursor = (onMove?: (cursor: Vector2, event: MouseEvent) => void, target?: HTMLElement) => {
...
export const createWorld = ({camera = defaultCamera, rendererConfig, withRaycaster = false}: CreateRendererArgs) => {
