...
!(function (e, n) {
      ...
      (j = n && n.parseEase('_CE'))
        ? ((b = 1),
          (n.parseEase('bounce').config = function (e) {
            return 'object' == typeof e ? t('', e) : t('bounce(' + e + ')', {strength: +e})
          }))
  ...
  var n,
    ...
    t = function _create(e, n) {
      ...
      return (
        d && (i(B), (B[2] = 'C' + B[2]), j(n.squashID || e + '-squash', 'M' + B.join(','))),
        i(y),
        (y[2] = 'C' + y[2]),
        j(e, 'M' + y.join(','))
      )
  ...
  g() && n.registerPlugin(o), (o.version = '3.7.1'), (e.CustomBounce = o), (e.default = o)
