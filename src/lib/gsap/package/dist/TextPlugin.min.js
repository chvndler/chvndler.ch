  ...
  function splitInnerHTML(D, u, F) {
    for (var C = D.firstChild, E = []; C; )
      3 === C.nodeType
        ? E.push.apply(
            E,
            emojiSafeSplit((C.nodeValue + '').replace(/^\n+/g, '').replace(/\s+/g, ' '), u, F)
          )
    ...
    F = {
      ...
      init: function init(D, u, F) {
        var C,
          ...
          s = this
        if (((s.svg = D.getBBox && ('TEXT' === r || 'TSPAN' === r)), !('innerHTML' in D || s.svg)))
          return !1
        if (((s.target = D), 'object' != typeof u && (u = {value: u}), 'value' in u)) {
          for (
          ...
          u.speed && F.duration(Math.min((0.05 / u.speed) * C.length, u.maxDuration || 9999)),
            (this.original = e),
            (this.text = E),
