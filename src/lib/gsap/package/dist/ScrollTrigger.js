      ...
      if (_lastMediaTick !== tick || _startup) {
        ...
        for (; i < _media.length; i += 4) {
          ...
          if (index !== _media[i + 3]) {
            ...
            index
              ? matches.push(i)
              : _revertAll(1, _media[i]) || (_isFunction(_media[i + 2]) && _media[i + 2]())
          }
        }
    ...
    _proto.init = function init(vars, animation) {
      ...
      if (pin) {
        pinSpacing === false ||
          pinSpacing === _margin ||
          (pinSpacing =
            !pinSpacing && _getComputedStyle(pin.parentNode).display === 'flex' ? false : _padding)
        self.pin = pin
        vars.force3D !== false &&
          gsap.set(pin, {
            force3D: true,
      ...
      self.refresh = function (soft, force) {
        ...
        if (pin) {
          ...
          !max &&
            ...
            ((isViewport ? _body : scroller).style['overflow-' + direction.a] = 'scroll')
        ...
        animation &&
          ...
          animation.progress(prevAnimProgress, true).render(animation.time(), true, true)
      ...
      self.update = function (reset, recordVelocity) {
        ...
        if (clipped !== prevProgress && self.enabled) {
          ...
          if (stateChanged && !_refreshing) {
            toggleState =
              clipped && !prevProgress ? 0 : clipped === 1 ? 1 : prevProgress === 1 ? 2 : 3
