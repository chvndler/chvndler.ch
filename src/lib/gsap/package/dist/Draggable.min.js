...
!(function (e, t) {
              ...
              -(r = (function _getCTM(e) {
                ...
                return (
                  n ||
                    ...
                    t
                      ? (e.style[v] = t)
                      : e.style.removeProperty(v.replace(/([A-Z])/g, '-$1').toLowerCase())),
                  n
                )
              })(e)).e / r.a),
            (a = -r.f / r.d),
  ...
  function da(e, t) {
    var n = me.createElementNS
      ? me.createElementNS((t || 'http://www.w3.org/1999/xhtml').replace(/^https/, 'http'), e)
      : me.createElement(e)
  ...
  function va(e) {
    ...
    ge.to(ua, {overwrite: !0, delay: 15, duration: 0, onComplete: ua, data: '_draggable'})
  }
  function xa(e, t, n, o) {
  ...
  function Ia(e, t) {
    ...
    return Math.max(
      0,
      Fe(e) ? Math.max(ye[o], l[o]) - (xe['inner' + n] || ye[r] || l[r]) : e[o] - e[r]
    )
  }
  function Ja(e, t) {
    var n = Ia(e, 'x'),
  ...
  function Na(e) {
    if (e === xe)
      return (
        (u.left = u.top = 0),
        (u.width = u.right = ye.clientWidth || e.innerWidth || l.clientWidth || 0),
        (u.height = u.bottom =
  ...
  function Oa(e, t, n) {
    var o,
      ...
      a = e._listeners[t]
    return (
      X(i) && (o = i.apply(r.callbackScope || e, r[n + 'Params'] || [e.pointerEvent])),
  ...
  function Sa(r, i, e, t, a, n) {
    ...
    if (i)
      if (1 !== a && i instanceof Array) {
        if (((c.end = o = []), (s = i.length), Y(i[0]))) for (l = 0; l < s; l++) o[l] = pa(i[l], a)
  ...
  function Ta(e) {
    ...
    return (
      ...
      (!(
        ...
        ('false' === t ||
          (!e.onclick && !o.test(e.nodeName + '') && 'true' !== e.getAttribute('contentEditable')))
      ) ||
        Ta(e.parentNode))
    )
  }
          ...
          (r &&
            ...
            (r && !e) ||
              ...
              (v = Math.max(0, i.scrollWidth - i.clientWidth)) &&
                (v += parseFloat(t.paddingLeft) + (k ? parseFloat(t.paddingRight) : 0))),
            ...
            : (e.viewBox &&
              ...
              p ||
                ...
                (p =
                  ...
                  (u ? 0 : parseFloat(f.borderLeftWidth) + parseFloat(f.borderRightWidth))),
                (h =
                  (parseFloat(f.height) || e.clientHeight || 0) +
                  (u ? 0 : parseFloat(f.borderTopWidth) + parseFloat(f.borderBottomWidth))))),
          (o = p),
          (i = h)
      }
      return e === t
        ...
        return f || !n
          ...
          : ((i = -1 !== (n + '').indexOf('%')),
            ...
            !(o.width < 0 || o.height < 0) &&
              (i
                ? p * h * (n *= 0.01) <= (r = o.width * o.height) || r >= l.width * l.height * n
  ...
  function Draggable(h, u) {
    ...
    ;(e = We.call(this) || this),
      ...
      (e.edgeResistance = isNaN(u.edgeResistance) ? 1 : parseFloat(u.edgeResistance) || 0),
          ...
          (t = (n = Fe(c.parentNode)) ? He : c.parentNode),
            ...
            $ &&
              ((s = t._gsMaxScrollY - t.scrollTop) < 0
                ? (l = s)
                : i > o.bottom - oe && s
                ? ((ee = !0), (l = Math.min(s, (d * (1 - Math.max(0, o.bottom - i) / oe)) | 0)))
                : i < o.top + te &&
                  t.scrollTop &&
                  ((ee = !0),
                  (l = -Math.min(t.scrollTop, (d * (1 - Math.max(0, i - o.top) / te)) | 0))),
              l && (t.scrollTop += l)),
            U &&
              ((s = t._gsMaxScrollX - t.scrollLeft) < 0
                ? (a = s)
                : r > o.right - ne && s
                ? ((ee = !0), (a = Math.min(s, (d * (1 - Math.max(0, o.right - r) / ne)) | 0)))
                : r < o.left + re &&
                  t.scrollLeft &&
                  ((ee = !0),
                  (a = -Math.min(t.scrollLeft, (d * (1 - Math.max(0, r - o.left) / re)) | 0))),
              a && (t.scrollLeft += a)),
            n &&
              (a || l) &&
              (xe.scrollTo(t.scrollLeft, t.scrollTop), pe(J.pointerX + a, J.pointerY + l)),
            (c = t)
      }
      if (O) {
        var u = J.x,
        ...
        G
          ...
          : f
          ? ($ && ((J.deltaY = p - f.top()), f.top(p)), U && ((J.deltaX = u - f.left()), f.left(u)))
          : W
          ? ($ && ((J.deltaY = p - parseFloat(le.y)), (le.y = p + 'px')),
            U && ((J.deltaX = u - parseFloat(le.x)), (le.x = u + 'px')),
            le.renderTransform(1, le))
          : ($ && ((J.deltaY = p - parseFloat(h.style.top || 0)), (h.style.top = p + 'px')),
            U && ((J.deltaX = u - parseFloat(h.style.left || 0)), (h.style.left = u + 'px'))),
          !g ||
            e ||
            H ||
      ...
      h._gsap || (le = ge.core.getCache(h)),
        ...
        (P || k || _) &&
          ...
          (_ &&
            ...
            n.y !== J.y && ((J.y = n.y), (O = !0))),
          P && (n = P(J.x)) !== J.x && ((J.x = n), G && (J.rotation = n), (O = !0)),
          k && ((n = k(J.y)) !== J.y && (J.y = n), (O = !0))),
        O && vh(!0),
        e || ((J.deltaX = J.x - r), (J.deltaY = J.y - i), Oa(J, 'throwupdate', 'onThrowUpdate'))
    }
    function xh(a, l, s, n) {
      return (
        null == l && (l = -Pe),
      ...
      ;(E = !1),
        f
          ...
          : u.bounds &&
            ...
            G
              ...
              ? ((t = Pa(h, h.parentNode)),
                (J.minX = L = Math.round(Og(K, 'px') + e.left - t.left - 0.5)),
                (J.minY = C = Math.round(Og(V, 'px') + e.top - t.top - 0.5)),
        ...
        u.liveSnap &&
          ...
          G
                  ...
                  X(s)
                    ? function (e) {
                        ...
                        return (
                          ...
                          (e.y = a = u < a ? u + (a - u) * r : a < d ? d + (a - d) * r : a),
                          (t = s.call(J, e)) !== e && ((e.x = t.x), (e.y = t.y)),
                          1 !== h && ((e.x *= h), (e.y *= h)),
                          p < Pe &&
                            ((n = e.x - i),
                            (o = e.y - a),
                    ...
                    ? function (e) {
                        for (var t, n, o, r, i = s.length, a = 0, l = Pe; -1 < --i; )
                          (r = (t = (o = s[i]).x - e.x) * t + (n = o.y - e.y) * n) < l &&
                            ((a = i), (l = r))
                        return l <= p ? s[a] : e
                      }
                    : function (e) {
            ...
            : (U && (P = xh(o ? n : n.x || n.left || n.scrollLeft, L, M, f ? -1 : 1)),
              $ && (k = xh(o ? n : n.y || n.top || n.scrollTop, C, S, f ? -1 : 1))))
    }
    function Ah() {
    ...
    function Ch(e, t) {
      ...
      e && Le
        ? (!0 === e &&
            ((n = u.snap || u.liveSnap || {}),
            (o = Ne(n) || X(n)),
            (e = {resistance: (u.throwResistance || u.resistance || 1e3) / (G ? 10 : 1)}),
            G
    ...
    function Dh(e) {
      ...
      ;(R = getGlobalMatrix(h.parentNode, !0)),
        e &&
          J.isPressed &&
          !R.equals(n || new fe()) &&
          ((t = n.inverse().apply({x: w, y: b})), R.apply(t, t), (w = t.x), (b = t.y)),
        R.equals(a) && (R = null)
    }
    function Eh() {
      var e,
          ...
          : (de() ? (wh(!0, !0), zh()) : J.applyBounds(),
            G
              ? ((e = h.ownerSVGElement
                  ...
                  : (La(h)[Ce] || '0 0').split(' ')),
                (N = J.rotationOrigin =
                  getGlobalMatrix(h).apply({x: parseFloat(e[0]) || 0, y: parseFloat(e[1]) || 0})),
                wh(!0, !0),
                (t = J.pointerX - N.x - r),
                (n = N.y - J.pointerY + i),
                (T = J.x),
    ...
    function Hh(e, t) {
      ...
      if (
        ...
        if (
          ...
          (J.pointerEvent = e),
          De[e.type]
            ? ((v = ~e.type.indexOf('touch') ? e.currentTarget || e.target : ce),
              xa(v, 'touchend', he),
              xa(v, 'touchmove', ue),
              xa(v, 'touchcancel', he),
              xa(ce, 'touchstart', Ca))
          ...
          (I = null),
          (Ye && v) || (xa(ce, 'mouseup', he), e && e.target && xa(e.target, 'mouseup', he)),
        ...
        if (
          ...
          (z = !B && !J.allowEventDefault) && (za(e), xa(xe, 'touchforcechange', za)),
          e.changedTouches
          ...
          !h.parentNode ||
            ...
            ve.parentNode ||
            h.getBBox ||
            ((ve.style.width = h.parentNode.scrollWidth + 'px'), h.parentNode.appendChild(ve)),
          Eh(),
          ...
          for (n = q.length; -1 < --n; )
            ge.set(q[n], {cursor: u.activeCursor || u.cursor || ('grab' === Se ? 'grabbing' : Se)})
        Oa(J, 'press', 'onPress')
      }
    }
    function Lh(e) {
      if (e && J.isDragging && !f) {
        ...
        ;(n || o) &&
          (R ? ((w -= n * R.a + o * R.c), (b -= o * R.d + n * R.b)) : ((w -= n), (b -= o)),
          (t._gsScrollX += n),
          (t._gsScrollY += o),
    ...
    function Mh(e) {
      ...
      if (
        ((r || (o && !1 !== J.vars.suppressClickOnDrag)) &&
          ...
          e.stopImmediatePropagation(),
        n && (!J.pointerEvent || !J.pointerEvent.defaultPrevented) && (!r || (l && !a)))
      )
        return l && r && (c = ae), void (F = ae)
      ;(J.isPressed || o || n) && ((l && e.detail && n && !i) || za(e)),
        n || o || (e && e.target && (J.pointerEvent = e), Oa(J, 'click', 'onClick'))
    }
    function Nh(e) {
      return R ? {x: e.x * R.a + e.y * R.c + R.e, y: e.x * R.b + e.y * R.d + R.f} : {x: e.x, y: e.y}
    }
    var p,
      f,
      w,
      ...
      ue = function onMove(e) {
        ...
        if (p && !Me && J.isPressed && e) {
          ...
          (((i = Math.abs(n - w)) !== (a = Math.abs(o - b)) && (j < i || j < a)) ||
            ...
            ? he(l)
            : ((z =
                J.allowEventDefault || (B && (!I || B === I)) || !1 === l.cancelable
                  ? z && !1
                  : (za(l), !0)),
              J.autoScroll && (ee = !0),
        ...
        ;(J.pointerX = e),
          ...
          G
            ? ((a = Math.atan2(N.y - t, e - N.x) * Oe),
              180 < (l = J.y - a) ? ((D -= 360), (J.y = a)) : l < -180 && ((D += 360), (J.y = a)),
              (i = J.x !== T || Math.abs(D - a) > j ? ((J.y = a), T + (D - a) * c) : T))
            : (R && ((s = e * R.a + t * R.c + R.e), (t = e * R.b + t * R.d + R.f), (e = s)),
              (r = t - b) < j && -j < r && (r = 0),
              (o = e - w) < j && -j < o && (o = 0),
              (J.lockAxis || J.lockedAxis) &&
                (o || r) &&
                ((s = J.lockedAxis) ||
                  ((J.lockedAxis = s = U && Math.abs(o) > Math.abs(r) ? 'y' : $ ? 'x' : null),
                  s && X(J.vars.onLockAxis) && J.vars.onLockAxis.call(J, J.pointerEvent)),
                'y' === s ? (r = 0) : 'x' === s && (o = 0)),
              (i = ba(T + o * c)),
              (a = ba(D + r * c))),
          (P || k || _) && (J.x !== i || (J.y !== a && !G))
            ? (_ && ((Ie.x = i), (Ie.y = a), (s = _(Ie)), (i = ba(s.x)), (a = ba(s.y))),
              P && (i = ba(P(i))),
              k && (a = ba(k(a))))
            : E &&
              (M < i
          ...
          (J.x === i && (J.y === a || G)) ||
            (G
              ...
              : ($ && ((J.y = J.endY = a), (O = !0)), U && ((J.x = J.endX = i), (O = !0))),
    ...
    return (
          ...
          if (
            ...
            for (
              ...
              (a = (l = Fe(i.parentNode)) ? He : i.parentNode),
                $ && a.scrollTop > a._gsMaxScrollY && (a.scrollTop = a._gsMaxScrollY),
                U && a.scrollLeft > a._gsMaxScrollX && (a.scrollLeft = a._gsMaxScrollX),
                (i = a)
          J.isThrowing &&
      ...
      (e.update = function (e, t, n) {
        ...
        return (
          ...
          J.isPressed &&
            !t &&
            ((U && 0.01 < Math.abs(a - J.x)) || ($ && 0.01 < Math.abs(l - J.y) && !G)) &&
            Eh(),
          J.autoScroll &&
            (Ja(h.parentNode, J.isDragging), (ee = J.isDragging), vh(!0), Ga(h, Lh), Fa(h, Lh)),
          J
        )
      }),
      (e.enable = function (e) {
            ...
            ra(
              ...
              U == $
                ...
                : (u.allowNativeTouchScrolling &&
                    (h.scrollHeight === h.clientHeight) == (h.scrollWidth === h.clientHeight)) ||
                  u.allowEventDefault
                ? 'manipulation'
                : U
                ? 'pan-y'
        ...
        return (
          Fa(h, Lh),
          (p = !0),
          Le && 'soft' !== e && Le.track(f || h, W ? 'x,y' : G ? 'rotation' : 'top,left'),
          (h._gsDragID = t = 'd' + Ae++),
          (Re[t] = J),
        ...
        if ('soft' !== e) {
          for (ra(q, null), o = q.length; -1 < --o; )
            (t = q[o]),
              ...
              ya(t, 'contextmenu', uh)
          Ua(q, !0),
            v && (ya(v, 'touchcancel', he), ya(v, 'touchend', he), ya(v, 'touchmove', ue)),
            ya(ce, 'mouseup', he),
            ya(ce, 'mousemove', ue)
        }
        return (
          Ga(h, Lh),
          (p = !1),
          Le && 'soft' !== e && Le.untrack(f || h, W ? 'x,y' : G ? 'rotation' : 'top,left'),
          f && f.disable(),
          va(vh),
