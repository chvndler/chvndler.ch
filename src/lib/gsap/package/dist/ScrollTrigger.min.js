...
!(function (e, t) {
  ...
  function T(e, t) {
    ...
    return (r = 'scroll' + n) && (i = O(e, r))
      ? i() - Q(e)()[o]
      : N(e)
      ? Math.max(_e[r], Pe[r]) - (Me['inner' + n] || _e['client' + n] || Pe['client' + n])
      : e[r] - e['offset' + n]
  }
  function U(e, t) {
  ...
  function Ha(e, t) {
    if (V(e)) {
      ...
      ~r && (e.indexOf('%') > r && (n *= t / 100), (e = e.substr(0, r - 1))),
        (e =
          n +
          (e in C ? C[e] * t : ~e.indexOf('%') ? (parseFloat(e) * t) / 100 : parseFloat(e) || 0))
    }
    return e
  }
  function Ia(e, t, r, n, o, i, a) {
    ...
    return (
      ...
      (!g && d) || (b += (n === ot ? x : y) + ':' + (i + parseFloat(u)) + 'px;'),
    ...
    if (g !== r || De) {
      for (R(); o < E.length; o += 4)
        (t = Me.matchMedia(E[o]).matches) !== E[o + 3] &&
          ((E[o + 3] = t) ? n.push(o) : R(1, E[o]) || (W(E[o + 2]) && E[o + 2]()))
    ...
    if (i) {
      ...
      ;(f = 'scroll' + n.d2),
        S(
          ...
          b,
          n,
          (x && 20 < b) || (!x && (u ? Math.max(Pe[f], _e[f]) : i.parentNode[f]) <= b + 1)
        ),
        u && ((l = it(a)), u && (i.style[n.op.p] = l[n.op.p] - n.op.m - i._offset + rt))
    }
    return Math.round(e)
  }
  function ob(e, t, r, n) {
    ...
    F = function _updateAll() {
      if (!h) {
        ...
        if (
          ((ut = n < D ? -1 : 1),
          (D = n),
          r && (je && !Ie && 200 < t - je && ((je = 0), A('scrollEnd')), (Ae = m), (m = t)),
          ut < 0)
        ) {
  ...
  var ee =
      ...
      if (((this.progress = this.start = 0), this.vars && this.kill(1), Ue)) {
        ...
        ;(we.media = Ve),
          ...
          M &&
            ((M.vars.lazy = !1),
            M._initted ||
              (!1 !== M.vars.immediateRender && !1 !== S.immediateRender && M.render(0, !0, !0)),
          ...
          ae &&
            (!1 === se || se === et || (se = !(!se && 'flex' === ta(ae.parentNode).display) && Ge),
            (we.pin = ae),
            !1 !== S.force3D && Se.set(ae, {force3D: !0}),
            (n = Se.core.getCache(ae)).spacer
              ? (D = n.pinState)
              : ((n.spacer = j = ke.createElement('div')),
                j.setAttribute('class', 'pin-spacer' + (i ? ' pin-spacer-' + i : '')),
                (n.pinState = D = jb(ae))),
              ...
              if (ae && e && je) Ca(ScrollTrigger, 'scrollEnd', Va)
                ...
                for (
                  var r,
                    ...
                    m = S.end,
                    b = S.endTrigger || ie,
                    x = S.start || (0 !== S.start && ie ? (ae ? '0 0' : '0 100%') : 0),
                    y = S.pinnedContainer && Ee(S.pinnedContainer)[0],
                    w = (ie && Math.max(0, lt.indexOf(we))) || 0,
                    C = w;
                  C--;
                ...
                for (
                  E = mb(x, ie, p, re, we.scroll(), B, L, we, d, ye, me, g) || (ae ? -0.001 : 0),
                    W(m) && (m = m(we)),
                    V(m) &&
                      !m.indexOf('+=') &&
                      (~m.indexOf(' ')
                        ? (m = (V(x) ? x.split(' ')[0] : '') + m)
                        : ((h = Ha(m.substr(2), p)), (m = V(x) ? x : E + h), (b = ie))),
                    A =
                      Math.max(
                        E,
                        mb(
                  ...
                  (l = (s = lt[C]).pin) &&
                    ...
                    ((r = s.end - s.start), (l !== ie && l !== y) || (h += r), l === ae && (v += r))
                if (
                  ((E += h),
                  (A += h),
                  (we._pinPush = v),
                ...
                f &&
                  ...
                  G !== we.progress &&
                    (K && M.totalProgress(G, !0), (we.progress = G), we.update()),
          ...
          (we.update = function (e, t) {
            var r,
              ...
              u = we.progress
            if (
              (t && ((_ = k), (k = s), pe && ((x = b), (b = M && !ge ? M.totalProgress() : c))),
              ce &&
                !c &&
                ae &&
                !Be &&
              ...
              if (
                ((i = (a = (r = we.isActive = !!c && c < 1) != (!!u && u < 1)) || !!c != !!u),
    ...
    (ScrollTrigger.register = function register(e) {
      if (
        ...
        L() &&
          window.document &&
          ((Me = window), (ke = document), (_e = ke.documentElement), (Pe = ke.body)),
        Se &&
          ((Ee = Se.utils.toArray),
          (Ne = Se.utils.clamp),
  ...
  function ScrollTrigger(e, t) {
    i || ScrollTrigger.register(Se) || console.warn('Please gsap.registerPlugin(ScrollTrigger)'),
      this.init(e, t)
  }
  ;(ee.version = '3.7.1'),
