;(function (global, factory) {
    ...
    _getCTM = function _getCTM(svg) {
      ...
      if (!m) {
        ...
        transform
          ...
          : svg.style.removeProperty(_transformProp.replace(/([A-Z])/g, '-$1').toLowerCase())
      }
  ...
  var gsap,
      ...
      return Math.max(
        ...
        _isRoot(element)
          ? Math.max(_docElement$1[scroll], _body$1[scroll]) -
              (_win$1['inner' + dim] || _docElement$1[client] || _body$1[client])
    ...
    _getElementBounds = function _getElementBounds(element, context) {
      ...
      if (element === _win$1) {
        ...
        right =
          left +
          (doc.documentElement.clientWidth || element.innerWidth || doc.body.clientWidth || 0)
        bottom =
          top +
      ...
      var type = (vars.type || 'x,y').toLowerCase(),
        ...
        syncXY = function syncXY(skipOnUpdate, skipSnap) {
          ...
          if (xyMode) {
            ...
            self.y =
              parseFloat(target.style.top || ((cs = _getComputedStyle(target)) && cs.top)) || 0
  ...
  var gsap$1,
    ...
    _getGSAP$1 = function _getGSAP() {
      return (
        gsap$1 || (_windowExists$1() && (gsap$1 = window.gsap) && gsap$1.registerPlugin && gsap$1)
      )
    },
    ...
    _parseAnimation = function _parseAnimation(animationOrId) {
      return animationOrId instanceof Animation
        ? animationOrId
        : animationOrId
        ? gsap$1.getById(animationOrId)
        : null
    },
    _createElement$1 = function _createElement(type, container, cssText) {
      var element = _doc$2.createElementNS
        ? _doc$2.createElementNS(type === 'svg' ? _svgNS : _domNS, type)
    ...
    _createRootElement = function _createRootElement(element, minimal, css) {
      if (!_addedCSS) {
        _createElement$1('style', _docEl).innerHTML =
    ...
    _addListener$1 = function _addListener(e, type, callback, capture) {
      ...
      if (type === 'mousedown') {
        altType = !_isUndefined$1(e.onpointerdown)
          ? 'pointerdown'
          : !_isUndefined$1(e.ontouchstart)
          ? 'touchstart'
          : null
    ...
    _removeListener$1 = function _removeListener(e, type, callback) {
      ...
      type =
        type !== 'mousedown'
          ? null
          : !_isUndefined$1(e.onpointerdown)
          ? 'pointerdown'
          : !_isUndefined$1(e.ontouchstart)
          ? 'touchstart'
          : null
    ...
    _merge = function _merge() {
      ...
      if (_rootInstance) {
        ...
        while (t) {
          ...
          if (
            !(_isFunction$1(target) && target === t.vars.onComplete && !t._dur) &&
      ...
      var _self = this,
        ...
        updateList = function updateList() {
          var animations = _getChildrenOf(
              declaredAnimation && !vars.globalSync ? declaredAnimation : _recordedRoot,
              true
            ),
