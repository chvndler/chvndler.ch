...
!(function (e, t) {
      ...
      if (((n = g()), (M = n && n.parseEase('_CE')))) {
        ...
        ;(C = 1),
          (o('wiggle').config = function (e) {
            return 'object' == typeof e ? o('', e) : o('wiggle(' + e + ')', {wiggles: +e})
          })
  ...
  var n,
    ...
    o = function _create(e, t) {
      ...
      if (
        ...
        for (f.length = 4, n = w(p), o = 2 * Math.random() - 1, l = 2; l < c; l++)
          (d = n),
            (g = o),
            (n = w(p * l)),
            (o = 2 * Math.random() - 1),
  ...
  g() && n.registerPlugin(t), (t.version = '3.7.1'), (e.CustomWiggle = t), (e.default = t)
