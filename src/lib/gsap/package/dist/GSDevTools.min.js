...
!(function (e, t) {
      ...
      for (var t, o; e && e !== r; )
        (o = e._gsap) && o.uncache && o.get(e, 'x'),
          o &&
            ...
            !o.scaleY &&
            o.renderTransform &&
            ((o.scaleX = o.scaleY = 1e-4), o.renderTransform(1, o), t ? t.push(o) : (t = [o])),
          (e = e.parentNode)
      return t
    },
    M = [],
              ...
              -(i = (function _getCTM(e) {
                ...
                return (
                  o ||
                    ...
                    t
                      ? (e.style[y] = t)
                      : e.style.removeProperty(y.replace(/([A-Z])/g, '-$1').toLowerCase())),
                  o
                )
              })(e)).e / i.a),
            (a = -i.f / i.d),
  ...
  function getGlobalMatrix(e, t, o, n) {
    if (!e || !e.parentNode || (g || T(e)).documentElement === e) return new he()
    var i = _(e),
      r = E(e) ? M : k,
      a = P(e, o),
  ...
  function da(e, t) {
    var o = ve.createElementNS
      ? ve.createElementNS((t || 'http://www.w3.org/1999/xhtml').replace(/^https/, 'http'), e)
      : ve.createElement(e)
  ...
  function va(e) {
    for (var t = ze.length; t--; ) ze[t] === e && ze.splice(t, 1)
  ...
  function Ia(e, t) {
    ...
    return Math.max(
      0,
      Ie(e) ? Math.max(xe[n], s[n]) - (me['inner' + o] || xe[i] || s[i]) : e[n] - e[i]
    )
  }
  function Ja(e, t) {
    var o = Ia(e, 'x'),
  ...
  function Ka(e, t, o) {
    ...
    n &&
      (Z(n[t]) && (t = c(t, e) || t),
      null == o
        ? n.removeProperty && n.removeProperty(t.replace(/([A-Z])/g, '-$1').toLowerCase())
        : (n[t] = o))
  }
  function La(e) {
  ...
  function Oa(e, t, o) {
    var n,
      ...
      a = e._listeners[t]
    return (
      X(r) && (n = r.apply(i.callbackScope || e, i[o + 'Params'] || [e.pointerEvent])),
  ...
  function Pa(e, t) {
    ...
    return r.nodeType || r === me
      ...
      : ((i = {x: 0, y: 0}),
        {left: e.left - i.x, top: e.top - i.y, width: e.width, height: e.height})
  }
  function Sa(i, r, e, t, a, o) {
    ...
    if (r)
      if (1 !== a && r instanceof Array) {
        if (((c.end = n = []), (l = r.length), Y(r[0]))) for (s = 0; s < l; s++) n[s] = pa(r[s], a)
  ...
  function Ta(e) {
    ...
    return (
      ...
      (!(
        ...
        ('false' === t ||
          (!e.onclick && !n.test(e.nodeName + '') && 'true' !== e.getAttribute('contentEditable')))
      ) ||
        Ta(e.parentNode))
    )
  }
        ...
        ;(f = r.scrollTop),
          ...
          (i &&
            ...
            (i && !e) ||
              ...
              (u.width = 'auto'),
              (u.paddingRight = '0px'),
              (y = Math.max(0, r.scrollWidth - r.clientWidth)) &&
                (y += parseFloat(t.paddingLeft) + (O ? parseFloat(t.paddingRight) : 0))),
    ...
    z = function _getElementBounds(e, t) {
      ...
      if (e === me)
        (i = Da(v)),
          (n =
            (o = Ea(v)) +
            (v.documentElement.clientWidth || e.innerWidth || v.body.clientWidth || 0)),
          (r =
            i +
            ...
            : (e.viewBox &&
              ...
              u ||
                ...
                (u =
                  ...
                  (p ? 0 : parseFloat(h.borderLeftWidth) + parseFloat(h.borderRightWidth))),
                (g =
                  (parseFloat(h.height) || e.clientHeight || 0) +
                  (p ? 0 : parseFloat(h.borderTopWidth) + parseFloat(h.borderBottomWidth))))),
          (n = u),
          (r = g)
      }
      return e === t
        ...
        return h || !o
          ...
          : ((r = -1 !== (o + '').indexOf('%')),
            ...
            !(n.width < 0 || n.height < 0) &&
              (r
                ? u * g * (o *= 0.01) <= (i = n.width * n.height) || i >= s.width * s.height * o
  ...
  function Draggable(g, p) {
      ...
      if (j.autoScroll && j.isDragging && (ee || P)) {
        ...
        for (
          ...
          (t = (o = Ie(c.parentNode)) ? Ae : c.parentNode),
            ...
            o &&
              (a || s) &&
              (me.scrollTo(t.scrollLeft, t.scrollTop), ue(j.pointerX + a, j.pointerY + s)),
            (c = t)
      }
      if (P) {
        var p = j.x,
          u = j.y
        V
          ? ((j.deltaX = p - parseFloat(se.rotation)),
            (j.rotation = p),
            (se.rotation = p + 'deg'),
            se.renderTransform(1, se))
          : h
          ? (q && ((j.deltaY = u - h.top()), h.top(u)), K && ((j.deltaX = p - h.left()), h.left(p)))
          : G
          ? (q && ((j.deltaY = u - parseFloat(se.y)), (se.y = u + 'px')),
            K && ((j.deltaX = p - parseFloat(se.x)), (se.x = p + 'px')),
            se.renderTransform(1, se))
          : (q && ((j.deltaY = u - parseFloat(g.style.top || 0)), (g.style.top = u + 'px')),
            K && ((j.deltaX = p - parseFloat(g.style.left || 0)), (g.style.left = p + 'px'))),
          !f ||
            e ||
            A ||
            (!(A = !0) === Oa(j, 'drag', 'onDrag') &&
              (K && (j.x -= j.deltaX), q && (j.y -= j.deltaY), oi(!0)),
            (A = !1))
      }
      P = !1
    }
    function pi(e, t) {
      ...
      g._gsap || (se = fe.core.getCache(g)),
        ...
        G
          ? ((j.x = parseFloat(se.x)), (j.y = parseFloat(se.y)))
          : V
          ? (j.x = j.rotation = parseFloat(se.rotation))
          : h
          ? ((j.y = h.top()), (j.x = h.left()))
          : ((j.y = parseFloat(g.style.top || ((n = La(g)) && n.top)) || 0),
        ...
        (C || O || N) &&
          ...
          (N &&
            ((Be.x = j.x),
            (Be.y = j.y),
            (o = N(Be)).x !== j.x && ((j.x = o.x), (P = !0)),
            o.y !== j.y && ((j.y = o.y), (P = !0))),
          C && (o = C(j.x)) !== j.x && ((j.x = o), V && (j.rotation = o), (P = !0)),
          O && ((o = O(j.y)) !== j.y && (j.y = o), (P = !0))),
        P && oi(!0),
        e || ((j.deltaX = j.x - i), (j.deltaY = j.y - r), Oa(j, 'throwupdate', 'onThrowUpdate'))
    }
    function qi(a, s, l, o) {
      return (
        null == s && (s = -Xe),
        ...
        h
          ...
          : p.bounds &&
            ...
            V
              ...
              ? ((t = Pa(g, g.parentNode)),
                (j.minX = D = Math.round(Hh(W, 'px') + e.left - t.left - 0.5)),
                (j.minY = E = Math.round(Hh(U, 'px') + e.top - t.top - 0.5)),
                (j.maxX = k = Math.round(D + (e.width - t.width))),
                (j.maxY = S = Math.round(E + (e.height - t.height))))
              : ((e = p.bounds),
                (j.minX = D = e.minX),
                (j.minY = E = e.minY),
                (j.maxX = k = e.maxX),
                (j.maxY = S = e.maxY)),
            k < D && ((j.minX = k), (j.maxX = k = D), (D = j.minX)),
            S < E && ((j.minY = S), (j.maxY = S = E), (E = j.minY)),
            V && ((j.minRotation = D), (j.maxRotation = k)),
            (M = !0)),
        p.liveSnap &&
          ((o = !0 === p.liveSnap ? p.snap || {} : p.liveSnap),
          (n = Ce(o) || X(o)),
          V
            ? ((C = qi(n ? o : o.rotation, D, k, 1)), (O = null))
            : o.points
            ? (N = (function buildPointSnapFunc(l, s, c, d, p, u, g) {
                  ...
                  X(l)
                    ? function (e) {
                        ...
                        return (
                          ...
                          (t = l.call(j, e)) !== e && ((e.x = t.x), (e.y = t.y)),
                          1 !== g && ((e.x *= g), (e.y *= g)),
                          u < Xe &&
                            ((o = e.x - r),
                            (n = e.y - a),
                    ...
                    ? function (e) {
                        for (var t, o, n, i, r = l.length, a = 0, s = Xe; -1 < --r; )
                          (i = (t = (n = l[r]).x - e.x) * t + (o = n.y - e.y) * o) < s &&
                            ((a = r), (s = i))
                        return s <= u ? l[a] : e
                      }
                    : function (e) {
              ...
              })(n ? o : o.points, D, k, E, S, o.radius, h ? -1 : 1))
            : (K && (C = qi(n ? o : o.x || o.left || o.scrollLeft, D, k, h ? -1 : 1)),
    ...
    function vi(e, t) {
      ...
      e && Se
        ? (!0 === e &&
            ((o = p.snap || p.liveSnap || {}),
            (n = Ce(o) || X(o)),
            (e = {resistance: (p.throwResistance || p.resistance || 1e3) / (V ? 10 : 1)}),
            V
              ? (e.rotation = Sa(j, n ? o : o.rotation, k, D, 1, t))
              : (K &&
                  (e[W] = Sa(
                    j,
                ...
                (o.points || (Ce(o) && Y(o[0]))) &&
                  ((e.linkedProps = W + ',' + U), (e.radius = o.radius)))),
          (j.isThrowing = !0),
    ...
    function wi(e) {
      ...
      ;(z = getGlobalMatrix(g.parentNode, !0)),
        e &&
          j.isPressed &&
          !z.equals(o || new he()) &&
          ((t = o.inverse().apply({x: b, y: w})), z.apply(t, t), (b = t.x), (w = t.y)),
        z.equals(a) && (z = null)
    }
    function xi() {
      var e,
      ...
      wi(!1),
        ...
        (b = Fe.x),
        (w = Fe.y),
        P && (ue(j.pointerX, j.pointerY), oi(!0)),
        (d = getGlobalMatrix(g)),
        h
          ? (si(), (_ = h.top()), (T = h.left()))
          : (de() ? (pi(!0, !0), si()) : j.applyBounds(),
            V
              ? ((e = g.ownerSVGElement
                  ? [se.xOrigin - g.getBBox().x, se.yOrigin - g.getBBox().y]
                  : (La(g)[Pe] || '0 0').split(' ')),
                (L = j.rotationOrigin =
                  getGlobalMatrix(g).apply({x: parseFloat(e[0]) || 0, y: parseFloat(e[1]) || 0})),
                pi(!0, !0),
                (t = j.pointerX - L.x - i),
                (o = L.y - j.pointerY + r),
                (T = j.x),
                (_ = j.y = Math.atan2(o, t) * Oe))
              : ((_ = Hh(U, 'px')), (T = Hh(W, 'px')))),
        M &&
          n &&
    ...
    function Ai(e, t) {
      ...
      if (
        ...
        if (
          ...
          (j.pointerEvent = e),
          _e[e.type]
            ? ((y = ~e.type.indexOf('touch') ? e.currentTarget || e.target : ce),
              xa(y, 'touchend', ge),
              xa(y, 'touchmove', pe),
              xa(y, 'touchcancel', ge),
              xa(ce, 'touchstart', Ca))
            : ((y = null), xa(ce, 'mousemove', pe)),
          (B = null),
          (Le && y) || (xa(ce, 'mouseup', ge), e && e.target && xa(e.target, 'mouseup', ge)),
        ...
        if (
          ...
          (F = !H && !j.allowEventDefault) && (za(e), xa(me, 'touchforcechange', za)),
          e.changedTouches
          ...
          (function _addToRenderQueue(e) {
            ze.push(e), 1 === ze.length && fe.ticker.add(sa)
          })(oi),
          ...
          !g.parentNode ||
            ...
            ye.parentNode ||
            g.getBBox ||
            ((ye.style.width = g.parentNode.scrollWidth + 'px'), g.parentNode.appendChild(ye)),
          xi(),
          ...
          (!p.zIndexBoost && (V || h || !1 === p.zIndexBoost)) ||
          ...
          for (o = J.length; -1 < --o; )
            fe.set(J[o], {cursor: p.activeCursor || p.cursor || ('grab' === Ee ? 'grabbing' : Ee)})
        Oa(j, 'press', 'onPress')
      }
    }
    function Ei(e) {
      if (e && j.isDragging && !h) {
        ...
        ;(o || n) &&
          (z ? ((b -= o * z.a + n * z.c), (w -= n * z.d + o * z.b)) : ((b -= o), (w -= n)),
          (t._gsScrollX += o),
          (t._gsScrollY += n),
    ...
    function Fi(e) {
      ...
      ;(j.isPressed || n || o) && ((s && e.detail && o && !r) || za(e)),
        o || n || (e && e.target && (j.pointerEvent = e), Oa(j, 'click', 'onClick'))
    }
    function Gi(e) {
    ...
    var u,
      ...
      V = -1 !== o.indexOf('rotation'),
      W = V ? 'rotation' : G ? 'x' : 'left',
      U = G ? 'y' : 'top',
      K = !(!~o.indexOf('x') && !~o.indexOf('left') && 'scroll' !== o),
      ...
      pe = function onMove(e) {
        ...
        if (u && !ke && j.isPressed && e) {
          ...
          (o = Fe.x),
          (n = Fe.y),
          (((r = Math.abs(o - b)) !== (a = Math.abs(n - w)) && ($ < r || $ < a)) ||
            (De && H === B)) &&
            ((B = a < r && K ? 'x' : 'y'),
            ...
            ? ge(s)
            : ((F =
                j.allowEventDefault || (H && (!B || H === B)) || !1 === s.cancelable
                  ? F && !1
                  : (za(s), !0)),
              j.autoScroll && (ee = !0),
      ...
      ue = function setPointerPosition(e, t, o) {
        ...
        ;(j.pointerX = e),
          ...
          le && ((e -= Ea(ce)), (t -= Da(ce))),
          V
            ? ((a = Math.atan2(L.y - t, e - L.x) * Oe),
              180 < (s = j.y - a) ? ((_ -= 360), (j.y = a)) : s < -180 && ((_ += 360), (j.y = a)),
              (r = j.x !== T || Math.abs(_ - a) > $ ? ((j.y = a), T + (_ - a) * c) : T))
            : (z && ((l = e * z.a + t * z.c + z.e), (t = e * z.b + t * z.d + z.f), (e = l)),
              (i = t - w) < $ && -$ < i && (i = 0),
              (n = e - b) < $ && -$ < n && (n = 0),
              (j.lockAxis || j.lockedAxis) &&
                (n || i) &&
                ((l = j.lockedAxis) ||
                  ((j.lockedAxis = l = K && Math.abs(n) > Math.abs(i) ? 'y' : q ? 'x' : null),
                  l && X(j.vars.onLockAxis) && j.vars.onLockAxis.call(j, j.pointerEvent)),
                'y' === l ? (i = 0) : 'x' === l && (n = 0)),
              (r = ba(T + n * c)),
              (a = ba(_ + i * c))),
          (C || O || N) && (j.x !== r || (j.y !== a && !V))
            ? (N && ((Be.x = r), (Be.y = a), (l = N(Be)), (r = ba(l.x)), (a = ba(l.y))),
              C && (r = ba(C(r))),
              O && (a = ba(O(a))))
            : M &&
              (k < r
              ...
              V ||
                (S < a
                  ...
                  : a < E && (a = Math.round(E + (a - E) * d)))),
          (j.x === r && (j.y === a || V)) ||
            (V
              ? ((j.endRotation = j.x = j.endX = r), (P = !0))
              : (q && ((j.y = j.endY = a), (P = !0)), K && ((j.x = j.endX = r), (P = !0))),
            o && !1 === Oa(j, 'move', 'onMove')
              ? ((j.pointerX = p),
                (j.pointerY = u),
                (_ = g),
                (j.x = h),
      ...
      ge = function onRelease(e, t) {
        if (
          ...
          var o,
            ...
            d = fe.delayedCall(0.001, zi)
          if (
            (y
              ? (ya(y, 'touchend', onRelease),
                ya(y, 'touchmove', pe),
            ...
            (Le && y) ||
              (ya(ce, 'mouseup', onRelease), e && e.target && ya(e.target, 'mouseup', onRelease)),
            (P = !1),
            l && ((Q = He = Ne()), (j.isDragging = !1)),
            x && !c)
          )
            return (
              e && (ya(e.target, 'change', onRelease), (j.pointerEvent = s)),
              Ua(J, !1),
              Oa(j, 'release', 'onRelease'),
              Oa(j, 'click', 'onClick'),
              void (x = !1)
            )
          for (va(oi), n = J.length; -1 < --n; )
          ...
          return (
            c && s
              ? (za(s), (F = !0), Oa(j, 'release', 'onRelease'))
              : s && !l
              ? ((F = !1),
    ...
    return (
      ...
      (e.startDrag = function (e, t) {
        ...
        Ai(e || j.pointerEvent, !0),
          t &&
            ...
            (n = Na(g)),
            (i = Gi({x: o.left + o.width / 2, y: o.top + o.height / 2})),
            (r = Gi({x: n.left + n.width / 2, y: n.top + n.height / 2})),
            (b -= i.x - r.x),
            (w -= i.y - r.y)),
          j.isDragging || ((j.isDragging = !0), Oa(j, 'dragstart', 'onDragStart'))
      }),
      (e.drag = pe),
      ...
      (e.getDirection = function (e, t) {
        var o,
          ...
          a,
          s,
          l = 'velocity' === e && Se ? e : Y(e) && !V ? 'element' : 'start'
        return (
          'element' === l && ((a = Na(j.target)), (s = Na(e))),
          (o =
            'start' === l
              ? j.x - T
              : 'velocity' === l
          ...
          if (
            ...
            for (
              ...
              (a = (s = Ie(r.parentNode)) ? Ae : r.parentNode),
                ...
                (r = a)
          j.isThrowing &&
            (i || j.endX > k || j.endX < D || j.endY > S || j.endY < E) &&
            vi(p.inertia || p.throwProps, i)
        }
        return j
      }),
      (e.update = function (e, t, o) {
        ...
        return (
          wi(!t),
          e ? j.applyBounds() : (P && o && oi(!0), pi(!0)),
          t && (ue(j.pointerX, j.pointerY), P && oi(!0)),
          j.isPressed &&
            !t &&
            ((K && 0.01 < Math.abs(a - j.x)) || (q && 0.01 < Math.abs(s - j.y) && !V)) &&
            xi(),
          j.autoScroll &&
            (Ja(g.parentNode, j.isDragging), (ee = j.isDragging), oi(!0), Ga(g, Ei), Fa(g, Ei)),
          j
        )
      }),
      (e.enable = function (e) {
            ...
            ra(
              ...
              K == q
                ...
                : (p.allowNativeTouchScrolling &&
                    (g.scrollHeight === g.clientHeight) == (g.scrollWidth === g.clientHeight)) ||
                  p.allowEventDefault
                ? 'manipulation'
                : K
                ? 'pan-y'
      ...
      (e.disable = function (e) {
        for (var t, o = j.isDragging, n = J.length; -1 < --n; ) Ka(J[n], 'cursor', null)
        if ('soft' !== e) {
          for (ra(J, null), n = J.length; -1 < --n; )
            (t = J[n]),
              ...
              ya(t, 'contextmenu', ni)
          Ua(J, !0),
            y && (ya(y, 'touchcancel', ge), ya(y, 'touchend', ge), ya(y, 'touchmove', pe)),
            ya(ce, 'mouseup', ge),
            ya(ce, 'mousemove', pe)
        }
        return (
      ...
      (e.kill = function () {
        return (
          ...
          j.tween && j.tween.kill(),
          j.disable(),
          fe.set(J, {clearProps: 'userSelect'}),
      ...
      ~o.indexOf('scroll') &&
        ...
        (g = h.content)),
      V ? (n.rotation = 1) : (K && (n[W] = 1), q && (n[U] = 1)),
  ...
  function Bb(e, t, o) {
    ...
    return (
      ...
      'svg' === e && (n.setAttribute('xmlns', I), n.setAttribute('xmlns:xlink', F)),
      o && (n.style.cssText = o),
      n
    )
  }
  ...
  function Gb(e, t, o, n) {
    ...
    return (
      rb(e) &&
        ('=' === e.charAt(1)
          ? ((i = parseInt(e.charAt(0) + '1', 10) * parseFloat(e.substr(2))) < 0 &&
              0 === n &&
              (n = 100),
          ...
          : t === Q &&
            (0 < (r = e.indexOf('='))
              ? ((i = parseInt(e.charAt(r - 1) + '1', 10) * parseFloat(e.substr(r + 1))),
                (e = e.substr(0, r - 1)))
              : (i = 0),
            (a = K.getById(e)) &&
              (e =
  ...
  function Kb(t, e, o, n) {
    ...
    if (
      ...
      'mousedown' === e &&
        (r = ub(t.onpointerdown) ? (ub(t.ontouchstart) ? null : 'touchstart') : 'pointerdown'))
    )
      return (
        (i = function handler(e) {
          'select' !== e.target.nodeName.toLowerCase() && e.type === r
            ? (e.stopPropagation(), G && (e.preventDefault(), o.call(t, e)))
            : e.type !== r && o.call(t, e),
            (G = !0)
        }),
  ...
  function Mb(e, t, o, n) {
    ...
    n &&
      ((i = Bb('option', e)).setAttribute('value', t),
    ...
    ;(K = e || qb()),
      q ||
        (K &&
          ...
          (ee = K.core.Animation),
          (ie = K.timeline({data: 'indy', autoRemoveChildren: !0, smoothChildTiming: !0})).kill(),
          (ie._dp = 0),
          ie.to({}, {duration: 1e12}),
          (Q = K.timeline({
            data: 'root',
          ...
          (B.killTweensOf = function (e, t, o) {
            Q.killTweensOf(e, t, o), Q.killTweensOf.call(B, e, t, o)
          }),
          ...
          re(2, function () {
            var e, t, o
            if (!oe)
              for (Ob(), e = Q._first, o = Q._start; e; )
                (t = e._next),
            ...
            2 < ue.globalRecordingTime
              ? re(ue.globalRecordingTime - 2, function () {
  ...
  var K,
    ...
    G = !0,
    ue = function GSDevTools(r) {
      q || (Sb(), K || console.warn('Please gsap.registerPlugin(GSDevTools)')),
        (this.vars = r = r || {}),
        r.animation &&
          (
      ...
      function Un(e, t) {
        return !1 !== r.persist && pe && sessionStorage.setItem('gs-dev-' + e + r.id, t), t
      }
      function Vn(e) {
        var t
        if (!1 !== r.persist && pe)
      ...
      function Bo(c, d, p) {
        return function (e) {
          var t,
            ...
            l = a
          p &&
            (c !== M && (t = M.getBoundingClientRect()).left && (a += t.left + t.width - o.left),
            ...
            this.target === x &&
              (this.activated && (this.allowEventDefault = !1), (this.activated = !0)),
            (h = !0)
        }
      }
      function Do() {
      ...
      function Ho(e) {
        if (!z.isPressed) {
          ...
          if (o < D) return (D = o = Math.max(0, o)), (M.style.left = D + '%'), void R.startDrag(e)
          if (S < o)
            return (S = o = Math.min(100, o)), (k.style.left = S + '%'), void Y.startDrag(e)
          v.progress(o / 100).pause(), H(!0), z.startDrag(e)
        }
      }
      function Lo() {
        if (!z.isPressed) {
          ...
          o = (function _getChildrenOf(e, t) {
            for (var o = [], n = 0, i = K.core.Tween, r = e._first; r; )
              r instanceof i
                ...
                (r = r._next)
            return o
          })(a && !r.globalSync ? a : Q, !0),
          n = E.children,
          i = 0
        for (
          a && !r.globalSync ? o.unshift(a) : r.hideGlobalTimeline || o.unshift(Q), t = 0;
          t < o.length;
          t++
        )
          ((e = n[t] || Bb('option', E)).animation = o[t]),
            ...
            e.setAttribute(
              ...
              (e.innerHTML =
                o[t].vars.id +
                (i ? ' [' + i + ']' : o[t + 1] && o[t + 1].vars.id === o[t].vars.id ? ' [0]' : ''))
            )
      ...
      function Po(e) {
        ...
        if (
          ...
          if (
            ...
            (M.style.left = D + '%'),
            (k.style.left = S + '%'),
            c && (Un('animation', i.vars.id), Un('in', D), Un('out', S)),
            (s = 0),
            ...
            o < l - s && (l = s + o),
              ...
              P
                ...
                : re(0.01, function () {
                    te.resume().progress(D / 100), P && B()
                  })
          } else {
            if ((oe === p && (oe = null), i !== a && a)) {
              for (
              ...
              o < l - s && (l = s + o),
                a.pause(s),
                (v = K.to(a, {duration: l - s, time: l, ease: 'none', data: 'root', parent: ie}))
            } else (v = i), !d && v._repeat && Mo(!0)
            v.timeScale(n), te.pause(), Q.resume(), v.seek(0)
          }
          ;(T.innerHTML = v.duration().toFixed(2)), Mb(E, i.vars.id, L)
        }
      }
      function Ro(e) {
      ...
      function So() {
        ...
        v.timeScale(t),
          ...
          P ||
            (v.progress() >= S / 100
              ? ((e = v._targets && v._targets[0]) === i && e.seek(s + ((l - s) * D) / 100),
      ...
      function Wo() {
        G || (F.play(), V.pause(), (G = !0))
      }
      function Xo() {
        V.pause(), G && (F.reverse(), (G = !1))
      }
      function $o(e) {
        se && !le && (le = Q._start),
          (c = !e),
        ...
        t && ((t._inProgress = Vn('in') || 0), (t._outProgress = Vn('out') || 100)),
          r.paused && A(),
          (i = null),
          Po(a || t || Q)
        var o = r.timeScale || Vn('timeScale'),
          n = t === i
        o && (Mb(X, o, N, o + 'x'), v.timeScale(o)),
          100 === (D = ('inTime' in r ? Gb(r.inTime, i, 0, 0) : n ? t._inProgress : 0) || 0) &&
            !r.animation &&
            t &&
            (Po(Q), (D = Gb(r.inTime, i, 0, 0) || 0)),
          D && ((M.style.left = D + '%'), (M.style.display = k.style.display = 'block')),
          (S = ('outTime' in r ? Gb(r.outTime, i, 100, D) : n ? t._outProgress : 0) || 100) < D &&
            (S = 100),
          100 !== S && ((k.style.left = S + '%'), (M.style.display = k.style.display = 'block')),
      ...
      var u,
            ...
            o &&
              (rb(o)
                ...
                : (function _isObject(e) {
                    return 'object' == typeof e
                  })(o) && ((o.data = 'root'), K.set(n, o).kill()),
              n.style.top && (n.style.bottom = 'auto'),
              n.style.width &&
                K.set(n, {xPercent: -50, left: '50%', right: 'auto', data: 'root'}).kill()),
            !t &&
              n.offsetWidth < 600 &&
        ...
        P = !1,
        C = Tn('.loop'),
        O = (function _buildLoopAnimation(e) {
          var t = K.timeline({
            data: 'root',
            id: 'loop',
            parent: ie,
        ...
        X = Tn('.time-scale select'),
        N = Tn('.time-scale-label'),
        z = U.create(x, {
          type: 'x',
          cursor: 'ew-resize',
        ...
        R = U.create(M, {
          ...
          onRelease: function onRelease() {
            D < 0 && (D = 0),
              ...
              (M.style.left = D + '%'),
              Un('in', D),
              K.set(M, {x: 0, data: 'root', display: 'block'}),
              P || v.resume()
          },
        })[0],
        Y = U.create(k, {
          ...
          onRelease: function onRelease() {
            100 < S && (S = 100),
              ...
              (k.style.left = S + '%'),
              Un('out', S),
              K.set(k, {x: 0, data: 'root', display: 'block'}),
              m || (B(), v.resume())
          },
        })[0],
        H = function updateProgress(e) {
          if (!z.isPressed || !0 === e) {
            var t,
              ...
              n =
                i._repeat && i._rDelay && i.totalTime() % (i.duration() + i._rDelay) > i.duration()
            100 < o && (o = 100),
              S <= o
                ? !d || v.paused() || z.isDragging
                  ? ((o === S && -1 !== i._repeat) || ((o = S), v.progress(o / 100)),
                    !P && (S < 100 || 1 === i.totalProgress() || -1 === i._repeat) && A())
                  : n ||
                    ((o = D),
                    (t = v._targets && v._targets[0]) === i && t.seek(s + ((l - s) * D) / 100),
                    0 < i._repeat && !D && 100 === S
                      ? 1 === i.totalProgress() && v.totalProgress(0, !0).resume()
      ...
      Kb(E, 'change', Ro),
        ...
        Kb(X, 'change', So),
        'auto' === r.visibility
          ? (Kb(n, 'mouseout', Vo), Kb(n, 'mouseover', Xo))
          : 'hidden' === r.visibility && ((G = !0), F.progress(1)),
        !1 !== r.keyboard &&
          (ne && r.keyboard
            ? console.warn(
              ...
              Kb(
                ...
                (e = function keyboardHandler(e) {
                  ...
                  32 === o
                    ? I()
                    : 38 === o
                    ? ((t = parseFloat(Nb(X, -1, N))), v.timeScale(t), Un('timeScale', t))
                    : 40 === o
                    ? ((t = parseFloat(Nb(X, 1, N))), v.timeScale(t), Un('timeScale', t))
                    : 37 === o
                    ? Lo()
                    ...
                    : 73 === o
                    ? ((D = 100 * v.progress()), Un('in', D), (M.style.left = D + '%'), H(!0))
                    : 79 === o &&
                      ((S = 100 * v.progress()), Un('out', S), (k.style.left = S + '%'), H(!0))
                })
              ))),
        K.set(x, {xPercent: -50, x: 0, data: 'root'}),
        K.set(M, {xPercent: -100, x: 0, data: 'root'}),
  ...
  ;(ue.version = '3.7.1'),
    ...
    (ue.getByAnimation = function (e) {
      for (var t in (rb(e) && (e = K.getById(e)), de)) if (de[t].animation() === e) return de[t]
    }),
