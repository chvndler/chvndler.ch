;(function (global, factory) {
  ...
  var Animation = (function () {
    ...
    _proto.timeScale = function timeScale(value) {
      ...
      var tTime =
        this.parent && this._ts ? _parentToChildTotalTime(this.parent._time, this) : this._tTime
      this._rts = +value || 0
  ...
  var _win$1,
    ...
    _applySVGOrigin = function _applySVGOrigin(
      ...
      if (!originIsAbsolute) {
        ...
        xOrigin =
          bounds.x + (~originSplit[0].indexOf('%') ? (xOrigin / 100) * bounds.width : xOrigin)
        yOrigin =
          bounds.y +
    ...
    _addPxTranslate = function _addPxTranslate(target, start, value) {
      ...
      return (
        _round(parseFloat(start) + parseFloat(_convertToUnit(target, 'x', value + 'px', unit))) +
        unit
      )
    },
    ...
    init: function init(target, vars, tween, index, targets) {
      ...
      for (p in vars) {
        ...
        if (specialProp) {
          ...
          relative =
            type === 'string' && endValue.charAt(1) === '=' ? +(endValue.charAt(0) + '1') : 0
