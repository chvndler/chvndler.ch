...
!(function (t, e) {
        ...
        if (!c) {
          ...
          'random' === g && Wa(c),
            ...
            (c.v = d =
              (parseFloat(_.amount) ||
                parseFloat(_.each) *
                  (d < f ? d - 1 : T ? ('y' === T ? d / f : f) : Math.max(f, d / f)) ||
                0) * ('edges' === g ? -1 : 1)),
            (c.b = d < 0 ? v - d : v),
  ...
  function Za(u, t) {
    ...
    return (
      !e &&
        s(u) &&
        ((h = e = u.radius || X),
        u.values ? ((u = xt(u.values)), (l = !q(u[0])) && (h *= h)) : (u = Ya(u.increment))),
      Na(
        t,
        e
          ? p(u)
  ...
  function vb(t) {
    ...
    if (((At.lastIndex = 0), At.test(r)))
      return (e = Ct.test(r)), (t[1] = sb(t[1], e)), (t[0] = sb(t[0], e, rb(t[1]))), !0
  }
  function Eb(t) {
    var e = (t + '').split('('),
      r = zt[e[0]]
  ...
  var Rt,
    ...
    Nt =
      ...
      (Rt.totalDuration = function totalDuration(t) {
        return arguments.length
          ? ((this._dirty = 0),
            Ia(this, this._repeat < 0 ? t : (t - this._repeat * this._rDelay) / (this._repeat + 1)))
          : this._tDur
      }),
      ...
      (Rt.time = function time(t, e) {
        return arguments.length
          ? this.totalTime(
              Math.min(this.totalDuration(), t + va(this)) % (this._dur + this._rDelay) ||
                (t ? this._dur : 0),
              e
            )
          : this._time
      ...
      (Rt.progress = function progress(t, e) {
        return arguments.length
          ? this.totalTime(
              this.duration() * (!this._yoyo || 1 & this.iteration() ? t : 1 - t) + va(this),
              e
            )
          : this.duration()
    ...
    return (
      ...
      (e.render = function render(t, e, r) {
        ...
        if (v !== this._tTime || r || y) {
          ...
          if (
            h &&
            !e &&
            (this.pause(), (h.render(_ <= i ? 0 : -U)._zTime = _ <= i ? 1 : -1), this._ts)
          )
          ...
          this._onUpdate && !e && Pt(this, 'onUpdate', !0),
            ((v === m && m >= this.totalDuration()) || (!v && _)) &&
              ((f !== this._start && Math.abs(l) === Math.abs(this._ts)) ||
                this._lock ||
                ((!t && g) || !((v === m && 0 < this._ts) || (!v && this._ts < 0)) || ra(this, 1),
                e ||
                  (t < 0 && !_) ||
                  (!v && !_ && m) ||
      ...
      (e.remove = function remove(t) {
        return o(t)
          ...
          : p(t)
          ? this.killTweensOf(t)
          : (qa(this, t), t === this._recent && (this._recent = this._last), sa(this))
      }),
        ...
        return arguments.length
          ? ((this._forcing = 1),
            !this._dp &&
              this._ts &&
              (this._start = ca(
                St.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts)
              )),
          ...
          if (
            ...
            for (a in i)
              ft[a] && (f = Sb(a, i, e, c, o, I))
                ? f.priority && (u = 1)
                : (d[a] = s = Xt.call(e, o, a, 'get', i[a], c, I, 0, g.stringFilter))
          e._op && e._op[n] && e.kill(o, e._op[n]),
            E &&
              e._pt &&
              ((Yt = e), R.killTweensOf(o, d, e.globalTime(0)), (m = !e.parent), (Yt = 0)),
            e._pt && T && (lt[h.id] = 1)
        }
    ...
    Qt = (function (C) {
      function Tween(e, r, i, n) {
        ...
        if (
          ((a._targets = A.length
            ? $(A)
            : O('GSAP target ' + e + ' not found. https://greensock.com', !Y.nullTargetWarn) || []),
          (a._ptLookup = []),
          (a._overwrite = T),
          w || b || v(m) || v(g))
        ) {
          if (
            ((r = a.vars),
            (o = a.timeline = new qt({data: 'nested', defaults: x || {}})).kill(),
      ...
      return (
          ...
          if (p) {
            if (
              ...
              if (((i = _), (l = this.timeline), this._repeat)) {
                ...
                a !== o &&
                  ...
                  !this.vars.repeatRefresh ||
                    u ||
                    this._lock ||
                    ((this._lock = r = 1), (this.render(ca(s * a), !0).invalidate()._lock = 0)))
              }
              if (!this._initted) {
              ...
              ;(l && l.render(t < 0 ? t : !i && u ? -U : l._dur * h, e, r)) ||
                ...
                this._onUpdate &&
                  !e &&
                  (t < 0 && this._startAt && this._startAt.render(t, !0, r), Pt(this, 'onUpdate')),
                this._repeat &&
                  a !== o &&
                  this.vars.onRepeat &&
                  !e &&
                ...
                (_ !== this._tDur && _) ||
                  ...
                  (!t && p) ||
                    !((_ === this._tDur && 0 < this._ts) || (!_ && this._ts < 0)) ||
                    ra(this, 1),
                  e ||
                    (t < 0 && !d) ||
                    (!_ && !d) ||
            ...
            !(function _renderZeroDurationTween(t, e, r, i) {
              ...
              if (
                (h &&
                  ...
                  (s = gt(t._tTime, h)),
                  t._yoyo && 1 & a && (u = 1 - u),
                  a !== s && ((o = 1 - u), t.vars.repeatRefresh && t._initted && t.invalidate())),
                ...
                t._startAt && e < 0 && t._startAt.render(e, !0, !0),
                  ...
                  (e >= t._tDur || e < 0) &&
                    t.ratio === u &&
                    (u && ra(t, 1),
                    r || (Pt(t, u ? 'onComplete' : 'onReverseComplete', !0), t._prom && t._prom()))
        ...
        (e.kill = function kill(t, e) {
          ...
          if (this.timeline) {
            ...
            return (
              this.timeline.killTweensOf(t, e, Yt && !0 !== Yt.vars.overwrite)._first || kb(this),
              this.parent &&
          ...
          for (
            ...
            if (~d.indexOf(f[l]))
              ...
              s))
                (h = n && n[u]) &&
                  (('kill' in h.d && !0 !== h.d.kill(u)) || qa(this, h, '_pt'), delete n[u]),
                  'all' !== a && (a[u] = 1)
  ...
  var se = {
    ...
    exportRoot: function exportRoot(e, r) {
      ...
      for (
        ...
        (n = i._next),
          (!r && !i._dur && i instanceof Qt && i.vars.onComplete === i._targets[0]) ||
            ...
            for (r in e)
              for (i = a.length; i--; )
                (n = (n = t._ptLookup[i][r]) && n.d) &&
                  (n._pt && (n = nc(n, r)), n && n.modifier && n.modifier(e[r], t, a[i], r))
          })(t, i)
        }
      },
    }
  ...
  function nd(t, e) {
    var r = he.createElementNS
      ? he.createElementNS((e || 'http://www.w3.org/1999/xhtml').replace(/^https/, 'http'), t)
      : he.createElement(t)
    ...
    return (
      ...
      Ie[e] && 'transform' !== e
        ...
        : ((n = t.style[e]) && 'auto' !== n && !i && !~(n + '').indexOf('calc(')) ||
          (n = (Qe[e] && Qe[e](t, e, r)) || od(t, e) || aa(t, e) || ('opacity' === e ? 1 : 0)),
  ...
  function Bd(t, e, r, i) {
    ...
    if (
      ...
      (v.e = i),
      (r += ''),
      'auto' === (i += '') && ((t.style[e] = i), (i = od(t, e) || i), (t.style[e] = r)),
      vb((s = [r, i])),
      (i = s[1]),
      (u = (r = s[0]).match(rt) || []),
      (i.match(rt) || []).length)
  ...
  function Xd(t, e, r) {
    ...
    for (n in (l.svg
      ...
      : ((a = getComputedStyle(r)[Ye]), (f[Ye] = e), (i = $e(r, 1)), (f[Ye] = a)),
    Ie))
      (a = l[n]) !== (s = i[n]) &&
  ...
  var ue,
    ...
    $e = function _parseTransform(t, e) {
      ...
      return (
        ...
        (m = Kd(t, r.svg)),
        r.svg &&
          ((k = (!r.uncache || '0px 0px' === L) && !e && t.getAttribute('data-svg-origin')),
        ...
        (r.x =
          i -
          ((r.xPercent =
            i && (r.xPercent || (Math.round(t.offsetWidth / 2) === Math.round(-i) ? -50 : 0)))
        ...
        (r.y =
          n -
          ((r.yPercent =
            n && (r.yPercent || (Math.round(t.offsetHeight / 2) === Math.round(-n) ? -50 : 0)))
    ...
    ir = function _renderSVGTransforms(t, e) {
      ...
      ;(d = parseFloat(d)),
        ...
        (v || y || b || T) &&
          ((x = ca(x + v - (v * r + y * n) + b)), (O = ca(O + y - (v * i + y * a) + T))),
        (u || h) &&
          ((s = g.getBBox()),
        ...
        for (f in (fe || rd(), e))
          if ('autoRound' !== f && ((s = e[f]), !ft[f] || !Sb(f, e, r, i, t, n)))
            if (
              ...
              if (
                (w && f in w
                  ? ((a = 'function' == typeof w[f] ? w[f].call(r, i, t, n) : w[f]),
                    f in Y.units && !Pa(a) && (a += Y.units[f]),
                    '=' === (a + '').charAt(1) && (a = Ad(t, f)))
                  : (a = Ad(t, f)),
                (u = parseFloat(a)),
                (p = 'string' === h && '=' === s.charAt(1) ? +(s.charAt(0) + '1') : 0) &&
                  (s = s.substr(2)),
                (o = parseFloat(s)),
                f in qe &&
                  ('autoAlpha' === f &&
                    (1 === u && 'hidden' === Ad(t, 'visibility') && o && (u = 0),
                    xd(
                      this,
                      T,
                      'visibility',
                ...
                if (
                  (m ||
                    ...
                    ((m = this._pt =
                      new ae(this._pt, T, Ye, 0, 1, g.renderTransform, g, 0, -1)).dep = 1)),
                  'scale' === f)
                )
                  (this._pt = new ae(
                    this._pt,
              ...
              if (_ || ((o || 0 === o) && (u || 0 === u) && !Ne.test(s) && f in T))
                (o = o || 0),
                  (d = (a + '').substr((u + '').length)) !==
                    (c = Pa(s) || (f in Y.units ? Y.units[f] : d)) && (u = zd(t, f, a, c)),
                  (this._pt = new ae(
                    this._pt,
                    _ ? g : T,
                    f,
                    u,
                    p ? p * o : o - u,
                    _ || ('px' !== c && 'zIndex' !== f) || !1 === e.autoRound ? $c : bd
                  )),
                  (this._pt.u = c || 0),
