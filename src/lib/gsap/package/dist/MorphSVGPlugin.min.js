...
!(function (t, e) {
            ...
            (r =
              o || i
                ? 'M' +
                  ...
                  'z'
                : 'M' + (n + c) + ',' + a + ' v' + p + ' h' + -c + ' v' + -p + ' h' + c + 'z'))
          : 'circle' === T || 'ellipse' === T
          ? ((l = 'circle' === T ? (o = i = x.r) * b : ((o = x.rx), (i = x.ry) * b)),
            (r =
              'M' +
              ((n = x.cx) + o) +
              ',' +
  ...
  function arcToSegment(t, e, r, n, a, o, i, s, h) {
    if (t !== s || e !== h) {
      ...
      for (V = 0; V < L.length; V += 2)
        (_ = L[V]), (P = L[V + 1]), (L[V] = _ * G + P * q + N), (L[V + 1] = _ * Q + P * H + z)
  ...
  function stringToRawPath(t) {
    ...
    for (e = 0; e < y; e++)
      if (
        ...
        (g = m),
          (c = v),
          ('C' !== u && 'S' !== u) || ((g += m - s[s.length - 4]), (c += v - s[s.length - 3])),
          i || (m = v = 0),
        ...
        if (
          ...
          (r = 7),
          1 < f.length &&
            (f.length < 3 ? ((c = g), (g = d), r--) : ((c = d), (g = f.substr(2)), (r -= 2)),
            (d = f.charAt(1)),
            (f = f.charAt(0))),
          (p = arcToSegment(
            m,
  ...
  function rawPathToString(t) {
    ...
    var e,
      ...
      i = t.length
    for (r = 0; r < i; r++) {
      for (a = t[r], o += 'M' + h(a[0]) + ',' + h(a[1]) + ' C', e = a.length, n = 2; n < e; n++)
        o +=
          h(a[n++]) +
          ',' +
          h(a[n++]) +
  ...
  function P(t) {
    var e,
      ...
      h = s
    for (n = 6; n < a; n += 6)
      o < (e = t[n]) ? (o = e) : e < i && (i = e), s < (r = t[n + 1]) ? (s = r) : r < h && (h = r)
    ...
    for (
      ...
      for (r = (i = t[m]).length, o = 6; o < r; o += 6)
        for (
          ...
          v < (n = ((h = x * s) * h * f + 3 * (l = 1 - h) * (h * u + l * p)) * h + g)
            ? (v = n)
            : n < y && (y = n),
            ...
            (Math.abs(i[0] - i[i.length - 2]) < 0.5 && Math.abs(i[1] - i[i.length - 1]) < 0.5)
              ? 'auto' === r || 'log' === r
                ? ((y[v] = r = V(i, o, !v || !1 === a)),
                  ...
                  T(i, 6 * r))
                : 'reverse' !== r && (v && r < 0 && reverseSegment(i), T(i, 6 * (r < 0 ? -r : r)))
              : !w &&
                (('auto' === r &&
                  Math.abs(o[0] - i[0]) +
                    Math.abs(o[1] - i[1]) +
  ...
  function ea(t, e) {
    for (var r, n, a, o, i, s, h, l, g, c, p, u, f = t.length, d = 0.2 * (e || 1); -1 < --f; ) {
      for (
  ...
  var r,
    ...
    tt = {
      ...
      init: function init(t, e, r, n, a) {
        ...
        if ((z(e) && (e = e.call(r, n, t, a)), 'string' == typeof e || e.getBBox || e[0]))
          e = {shape: e}
        ...
        if (
          ((l = 'POLYLINE' === (o = (t.nodeName + '').toUpperCase()) || 'POLYGON' === o),
          'PATH' !== o && !l && !e.prop)
        )
        ...
        if (
          ((h = (function _parseShape(t, e, r) {
            var n, a
            return (
              (!('string' == typeof t) || q.test(t) || (t.match(G) || []).length < 3) &&
                ((n = C(t)[0])
                  ? ((a = (n.nodeName + '').toUpperCase()),
                    e && 'PATH' !== a && ((n = convertToPath(n, !1)), (a = 'PATH')),
          ...
          if (
            ...
            for (
              ('log' !== e.precompile && !0 !== e.precompile) ||
                M('precompile:["' + rawPathToString(f) + '","' + rawPathToString(d) + '"]'),
