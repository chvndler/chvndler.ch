...
!(function (t, e) {
  ...
  function t() {
    ;(i = m()) &&
      ((g = i.utils.toArray), (n = i.utils.getUnit), (c = i.core.getCache), (a = i.ticker), (l = 1))
  }
  function u(t, e, r, i) {
    ;(this.t = t),
      (this.p = e),
    ...
    v = (function () {
      ...
      return (
        (e.get = function get(t, e) {
          var r,
            i,
            n = this._props[t] || console.warn('Not tracking ' + t + ' velocity.')
          return (
        ...
        (e.add = function add(t, e) {
          t in this._props ||
            (o || (a.add(r), (s = a.time)), (o = this._props[t] = new u(this.target, t, e, o)))
        }),
        ...
        (VelocityTracker.track = function track(e, r, i) {
          l || t()
          for (
            var n, o, a = [], s = g(e), c = r.split(','), u = (i || '').split(','), f = s.length;
            f--;
  ...
  function Y(t, e, r, i, n, o, a) {
    ...
    if (((r = isNaN(r) ? B : r), (i = isNaN(i) ? -B : i), M(e))) {
      if (((s = e.calculated ? e : (N(u) ? u(e, a) : X(e, u, r, i, o)) || e), !e.calculated)) {
        for (c in s) e[c] = s[c]
        e.calculated = !0
      }
      s = s[n]
    } else s = N(u) ? u(e, a) : w(u) ? X(e, u, r, i, o) : parseFloat(u)
    return r < s ? (s = r) : s < i && (s = i), {max: s, min: s, unitFactor: t.unitFactor}
  }
  function Z(t, e, r) {
  ...
  function ba(t, e, r, i) {
    if (e.linkedProps) {
      ...
      for (n = 0; n < f.length; n++)
        (a = e[(o = f[n])]) &&
          ((s = L(a.velocity) ? a.velocity : (c = c || j(t)) && c.isTracking(o) ? c.get(o) : 0),
  ...
  var h,
    ...
    w = Array.isArray,
    B = 1e10,
    I = {resistance: 1, checkpoint: 1, preventOvershoot: 1, linkedProps: 1, radius: 1, duration: 1},
    R = {
      version: '3.7.1',
      name: 'inertia',
                ...
                for (a in ((v = ba(t, y, k, T)), y))
                  I[a] ||
                    ...
                    M(s) &&
                      ...
                      'end' in s &&
                        ((s = Y(s, v && a in v ? v : l, s.max, s.min, a, y.radius, u)),
                        o && (C === e && (C = y = W(e)), (y[a] = V(s, y[a], 'end')))),
                      'max' in s && l > +s.max + 1e-10
                        ? ((d = s.unitFactor || P.unitFactors[a] || 1),
                          (p =
                            (f > s.max && s.min !== s.max) || (-15 < u * d && u * d < 45)
                              ? i + 0.1 * (r - i)
                              : _(f, s.max, u)) +
                            n <
                            m && (m = p + n))
                        : 'min' in s &&
                          ...
                          ((d = s.unitFactor || P.unitFactors[a] || 1),
                          (p =
                            (f < s.min && s.min !== s.max) || (-45 < u * d && u * d < 15)
                              ? i + 0.1 * (r - i)
                              : _(f, s.min, u)) +
                            n <
                            m && (m = p + n)),
        ...
        for (a in ((e = C), (C = 0), (d = ba(t, e, h, T)), e))
          I[a] ||
            ...
            L(s)
              ...
              : o && o.isTracking(a)
              ? (f = o.get(a))
              : console.warn('ERROR: No velocity was defined for ' + t + ' property: ' + a),
            (l = $(f, w)),
            (g = 0),
            (c = h(t, a)),
            (u = b(c)),
            ...
            M(s) &&
              ...
              'max' in s && +s.max < p
                ...
                : 'min' in s &&
                  +s.min > p &&
                  (k || s.preventOvershoot ? (l = s.min - c) : (g = s.min - c - l))),
            this._props.push(a),
      ...
      render: function render(t, e) {
        ...
        for (t = k(e.tween._time / e.tween._dur); r; )
          r.set(r.t, r.p, U(r.s + r.c1 * t + r.c2 * t * t) + r.u, r.d, t), (r = r._next)
      },
    }
