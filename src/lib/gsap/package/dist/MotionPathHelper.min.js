...
!(function (t, e) {
  ...
  function transformRawPath(t, e, n, i, s, a, o) {
    for (var r, h, l, c, d, u = t.length; -1 < --u; )
      for (h = (r = t[u]).length, l = 0; l < h; l += 2)
        (c = r[l]), (d = r[l + 1]), (r[l] = c * e + d * i + a), (r[l + 1] = c * n + d * s + o)
    return (t._dirty = 1), t
  }
  function arcToSegment(t, e, n, i, s, a, o, r, h) {
    if (t !== r || e !== h) {
      ...
      var w = (a === o ? -1 : 1) * Z(S),
        ...
        I = (D * H - k * T < 0 ? -1 : 1) * Math.acos((D * T + k * H) / Z(R * (T * T + H * H)))
      isNaN(I) && (I = u), !o && 0 < I ? (I -= g) : o && I < 0 && (I += g), (N %= g), (I %= g)
      var L,
        O = Math.ceil(U(I) / (g / 4)),
        X = [],
        G = I / O,
      ...
      for (L = 0; L < O; L++)
        (_ = W((s = N + L * G))),
          ...
          (D = W((s += G))),
          (k = j(s)),
          X.push(_ - q * m, m + q * _, D + q * k, k - q * D, D, k)
      for (L = 0; L < X.length; L += 2)
        (_ = X[L]), (m = X[L + 1]), (X[L] = _ * B + m * z + E), (X[L + 1] = _ * V + m * Y + M)
  ...
  function stringToRawPath(t) {
    ...
    for (e = 0; e < y; e++)
      if (
        ...
        r && (r.length < 8 ? --m.length : (A += r.length)),
          (v = h = i),
          (b = l = s),
          (r = [i, s]),
          m.push(r),
        ...
        (c = v),
          (d = b),
          ('C' !== g && 'S' !== g) || ((c += v - r[r.length - 4]), (d += b - r[r.length - 3])),
          o || (v = b = 0),
        ...
        (c = v - r[r.length - 4]),
          ...
          (e += 2)
      else if ('H' === a) qd(v, b, (v = i), b), (e += 1)
      else if ('V' === a) qd(v, b, v, (b = i + (o ? b - v : 0))), (e += 1)
      else if ('L' === a || 'Z' === a)
        'Z' === a && ((i = h), (s = l), (r.closed = !0)),
          ('L' === a || 0.5 < U(v - i) || 0.5 < U(b - s)) &&
            (qd(v, b, i, s), 'L' === a && (e += 2)),
          (v = i),
          (b = s)
      else if ('A' === a) {
        if (
          ...
          (n = 7),
          1 < p.length &&
            (p.length < 3 ? ((d = c), (c = f), n--) : ((d = f), (c = p.substr(2)), (n -= 2)),
            (f = p.charAt(1)),
            (p = p.charAt(0))),
          (u = arcToSegment(
            v,
  ...
  function bezierToPoints(t, e, n, i, s, a, o, r, h, l, c) {
    ...
    return (
      l || ((l = [t, e, o, r]), (c = 2)),
      l.splice(c || l.length - 2, 0, P, S),
      h * (w * w + C * C) < (x + E) * (x + E) &&
        ((d = l.length),
        bezierToPoints(t, e, u, g, v, b, P, S, h, l, c),
        bezierToPoints(P, S, y, A, _, m, o, r, h, l, c + 2 + (l.length - d))),
      l
    )
  }
  function pointsToSegment(t, e, n) {
    ...
    var i,
      ...
      w = A - b,
      C = P - y,
      x = Math.abs(t[v] - b) < 0.001 && Math.abs(t[v + 1] - y) < 0.001
    for (
      ...
      (i = b),
        ...
        (b === A && y === P) ||
          ...
          (_ = (w = A - b) * w + (C = P - y) * C),
          (m = (c = A - i) * c + (u = P - s) * u),
          (p = ((a = Math.acos((f + _ - m) / Z(4 * f * _))) / Math.PI) * e),
          (g = Z(f) * p),
          (p *= Z(_)),
          (b === i && y === s) ||
            (n < a
              ...
              : ((r = E(d, l)),
                S.push(o(b - W(r) * g), o(y - j(r) * g)),
                (r = E(C, w)),
                S.push(o(b), o(y), o(b + W(r) * p), o(y + j(r) * p)))))
    return (
      b !== A || y !== P || S.length < 4 ? S.push(o(A), o(P), o(A), o(P)) : (S.length -= 2),
      x && (S.splice(0, 6), (S.length = S.length - 6)),
      S
    )
  }
  function simplifyPoints(t, e) {
    ...
    for (e = Math.pow(e || 1, 2), n = 2; n < u; n += 2)
      e < (a = l - (i = parseFloat(t[n]))) * a + (o = c - (s = parseFloat(t[n + 1]))) * o &&
        (d.push(i, s), (l = i), (c = s))
    return (
  ...
  function getClosestProgressOnBezier(t, e, n, i, s, a, o, r, h, l, c, d, u, g) {
    ...
    for (A = P; y <= s; )
      (p =
        (f = (m = 1 - y) * m * m * o + 3 * m * m * y * h + 3 * m * y * y * c + y * y * y * u - e) *
          f +
        (_ = m * m * m * r + 3 * m * m * y * l + 3 * m * y * y * d + y * y * y * g - n) * _) < A &&
        ((A = p), (b = y)),
        (y += v)
    return 1 < t
  ...
  function C(t) {
    ...
    if (((f = window), (y = new R()), e)) {
      ;(m = (g = e).documentElement),
        (v = e.body),
        ((x = g.createElementNS('http://www.w3.org/2000/svg', 'g')).style.transform = 'none')
        ...
        e &&
          (n
            ? ((b = b || K(t)),
              ...
              b.appendChild(h))
            : (u || ((u = K(t)).style.cssText = r),
              (h.style.cssText = r + 'width:0.1px;height:0.1px;top:' + o + 'px;left:' + a + 'px'),
              u.appendChild(h))),
        h
      )
    }
  ...
  function N(t, e) {
    var n,
      ...
      d = t.parentNode
    if (t === f) return t
    if ((c.length || c.push(K(t, 1), K(t, 2), K(t, 3)), (n = h ? b : u), h))
      l
        ? ((a =
            -(s = (function _getCTM(t) {
              ...
              return (
                n ||
                  ...
                  e
                    ? (t.style[D] = e)
                    : t.style.removeProperty(D.replace(/([A-Z])/g, '-$1').toLowerCase())),
                n
              )
            })(t)).e / s.a),
          (o = -s.f / s.d),
            ...
            (i = (i = t.transform ? t.transform.baseVal : {}).numberOfItems
              ? 1 < i.numberOfItems
                ? (function _consolidate(t) {
                    for (var e = new R(), n = 0; n < t.numberOfItems; n++)
      ...
      if (((a = o = 0), M))
        for (i = t.offsetParent, s = t; (s = s && s.parentNode) && s !== i && s.parentNode; )
          4 < (f.getComputedStyle(s)[D] + '').length &&
  ...
  function getGlobalMatrix(t, e, n, i) {
    ...
    var s = (function _forceNonZeroScale(t) {
      ...
      d =
        ...
        (function _isFixed(t) {
          return (
            'fixed' === f.getComputedStyle(t).position ||
        ...
        r.left +
          (d
            ...
            : (function _getDocScrollLeft() {
                return f.pageXOffset || g.scrollLeft || m.scrollLeft || v.scrollLeft || 0
              })()),
        r.top +
          (d
            ? 0
            : (function _getDocScrollTop() {
                return f.pageYOffset || g.scrollTop || m.scrollTop || v.scrollTop || 0
              })())
      )
  ...
  function oa(t, e, n) {
    var i,
      s = L.createElementNS('http://www.w3.org/2000/svg', t),
      a = /([a-z])([A-Z])/g
  ...
  function Aa(t, e, n, i) {
    if (t.addEventListener) {
      ...
      ;(i = i || {passive: !1}),
        ...
        s && e !== s && 'pointer' !== s.substr(0, 7) && t.addEventListener(e, n, i)
  ...
  function Ba(t, e, n) {
    if (t.removeEventListener) {
      ...
      t.removeEventListener(i || e, n),
        i && e !== i && 'pointer' !== i.substr(0, 7) && t.removeEventListener(e, n)
  ...
  function La(t) {
    ...
    ;(this._matrix = this.target.transform.baseVal.getItem(0).matrix),
      (this._ctm = s),
      V[t.type]
        ? ((e = -1 !== t.type.indexOf('touch') ? t.currentTarget || t.target : L),
          Aa(e, 'touchend', i._onRelease),
          Aa(e, 'touchmove', i._onMove),
          Aa(e, 'touchcancel', i._onRelease),
          Aa(L, 'touchstart', Ea),
          Aa(c, 'touchforcechange', ma))
        : ((e = null), Aa(L, 'mousemove', i._onMove)),
      h || Aa(L, 'mouseup', i._onRelease),
      ma(t),
      Ia(),
      t.changedTouches
      ...
      1 === this._ctm.a && 0 === this._ctm.b && 0 === this._ctm.c && 1 === this._ctm.d
        ? (this._ctm = null)
        : ((n = i._startPointerX * this._ctm.a + i._startPointerY * this._ctm.c + this._ctm.e),
          (i._startPointerY =
            i._startPointerX * this._ctm.b + i._startPointerY * this._ctm.d + this._ctm.f),
          (i._startPointerX = n)),
      (i.isPressed = nt = !0),
  ...
  function Ma(t) {
    ...
    if (i._enabled && !a && i.isPressed && t) {
      ...
      ma(s),
        ...
        i.vars.onDrag && i.vars.onDrag.call(i.vars.callbackScope || i, i.pointerEvent)
    }
  }
  function Na(t, e) {
    var n = this
    if (
      ...
      if (
        (r
          ? (Ba(r, 'touchend', n._onRelease),
            Ba(r, 'touchmove', n._onMove),
            Ba(r, 'touchcancel', n._onRelease),
            Ba(L, 'touchstart', Ea))
          : Ba(L, 'mousemove', n._onMove),
        h ||
          (Ba(L, 'mouseup', n._onRelease), t && t.target && Ba(t.target, 'mouseup', n._onRelease)),
        o
          ? (n.isDragging = !1)
      ...
      return (
        a && !o && n.vars.onDragRelease
          ...
          : (a && ma(a),
            n.vars.onRelease && n.vars.onRelease.call(n.vars.callbackScope || n, n.pointerEvent)),
  ...
  var L,
    ...
    a = 0,
    ht =
      (((n = DraggableSVG.prototype).setPointerPosition = function setPointerPosition(t, e) {
        var n, i, s, a, o
        ;(this.pointerX = t),
          (this.pointerY = e),
          this._ctm &&
          ...
          this.snap &&
            !G &&
            ((st.x = s), (st.y = a), this.snap.call(this, st), (s = st.x), (a = st.y)),
          (this.x === s && this.y === a) ||
            ((this._matrix.f = this.y = a),
            (this._matrix.e = this.x = s),
            !this.isDragging &&
              this.isPressed &&
              ((this.isDragging = !0), Ga('onDragStart', this, this.pointerEvent)))
      }),
      (n.enabled = function enabled(t) {
        return arguments.length
          ? ((this._enabled = t)
              ? (h || Aa(this.target, 'mousedown', this._onPress),
                Aa(this.target, 'touchstart', this._onPress),
                Aa(this.target, 'click', this._onClick, !0))
              : ((e = this.isDragging),
                Ba(this.target, 'mousedown', this._onPress),
                Ba(this.target, 'touchstart', this._onPress),
                Ba(c, 'touchforcechange', ma),
                Ba(this.target, 'click', this._onClick),
                this.touchEventTarget &&
                  (Ba(this.touchEventTarget, 'touchcancel', this._onRelease),
                  Ba(this.touchEventTarget, 'touchend', this._onRelease),
                  Ba(this.touchEventTarget, 'touchmove', this._onMove)),
                Ba(L, 'mouseup', this._onRelease),
                Ba(L, 'mousemove', this._onMove),
                (this.isDragging = this.isPressed = !1),
                e && Ga('onDragEnd', this, this.pointerEvent)),
            this)
          : this._enabled
        var e
      }),
  ...
  function DraggableSVG(t, e) {
    ;(this.target = 'string' == typeof t ? L.querySelectorAll(t)[0] : t),
      (this.vars = e || {}),
      (this._onPress = Fa(La, this)),
      (this._onMove = Fa(Ma, this)),
      (this._onRelease = Fa(Na, this)),
      this.target.setAttribute(
        'transform',
        (this.target.getAttribute('transform') || '') + ' translate(0,0)'
      ),
      (this._matrix = qa(this.target)),
  ...
  var lt,
    ct =
      (((lt = Anchor.prototype).onPress = function onPress() {
        Ga('onPress', this)
      }),
      ...
      (lt.update = function update(t, e, n) {
        t && (this.rawPath = t),
          arguments.length <= 1 ? ((e = this.j), (n = this.i)) : ((this.j = e), (this.i = n))
        var i = this.smooth,
          s = this.rawPath[e],
  ...
  function Anchor(t, e, n, i, s) {
    ;(this.editor = t),
      (this.element = oa('path', t._selection, {
        fill: Q,
        stroke: Q,
        strokeWidth: 2,
      ...
      (this.vars = s || {}),
      (this._draggable = new ht(this.element, {
        callbackScope: this,
        onDrag: this.onDrag,
        snap: this.vars.snap,
  ...
  var dt,
    ut =
      (((dt = PathEditor.prototype)._onRelease = function _onRelease(t) {
        var e = this._editingAnchor
        e && ((i.x = e.segment[e.i]), (i.y = e.segment[e.i + 1])),
          Ba(c, 'touchforcechange', ma),
          Ga('onRelease', this, t)
      }),
      (dt.init = function init() {
        ...
        if (a && this._anchors && this._anchors.length) {
          for (e = 0; e < this._anchors.length; e++)
            this._anchors[e].element.parentNode.removeChild(this._anchors[e].element),
        ...
        return (
          ...
          this._g.setAttribute(
            ...
            (function _getConcatenatedTransforms(t) {
              for (
                var e = qa(t), n = t.ownerSVGElement;
        ...
        if ('hidden' === this._selection.style.visibility) this.select()
          ...
          for (
            this._draggable && this._draggable._onRelease(t),
              l &&
                ((s = t.clientX * l.a + t.clientY * l.c + l.e),
                (a = t.clientX * l.b + t.clientY * l.d + l.f)),
          ...
          ;(i = new ct(this, this._rawPath, r.j, e, h)),
            this._selection.appendChild(this._handle1),
            this._selection.appendChild(this._handle2),
      ...
      (dt._onPressAnchor = function _onPressAnchor(t) {
        ;-1 === this._selectedAnchors.indexOf(t)
          ? (G || (this._selectedAnchors.length = 0), this._selectedAnchors.push(t))
          : G &&
      ...
      (dt._deleteSelectedAnchors = function _deleteSelectedAnchors() {
        ...
        this._updateAnchors(),
          this.update(),
          this._saveState(),
          this.vars.onDeleteAnchor && this.vars.onDeleteAnchor.call(this.vars.callbackScope || this)
      }),
        ...
        X && q !== t && this._editingAnchor
          ? ((t.smooth = !t.smooth),
            ...
            !t.smooth || (d && !t.isClosedStart)
              ? t.smooth ||
                (d && !t.isClosedStart) ||
                ((r || t.isClosedStart) && ((h[l] = h[r]), (h[1 + l] = h[r + 1])),
              ...
              : ((e =
                ...
                i < 0.2 &&
                  ((i = Pa(h, r, l - 4) / 4),
                  (e = n || Math.atan2(h[r + 7] - h[l - 3], h[r + 6] - h[l - 4]))),
                s < 0.2 &&
                  ((s = Pa(h, r, r + 6) / 4),
                  (n = e || Math.atan2(h[r + 7] - h[l - 3], h[r + 6] - h[l - 4]))),
                (a = Math.sin(e)),
                (o = Math.cos(e)),
      ...
      (dt._updateAnchors = function _updateAnchors() {
        ...
        for (this._editingAnchor = i, t = 0; t < this._anchors.length; t++)
          this._anchors[t].element.style.fill =
            -1 !== this._selectedAnchors.indexOf(this._anchors[t]) ? Q : 'white'
        i &&
          (this._handle1.setAttribute('d', i.smooth ? this._circleHandle : this._squareHandle),
          this._handle2.setAttribute('d', i.smooth ? this._circleHandle : this._squareHandle)),
          (t = i ? i.i : 0),
          i && (t || i.isClosedStart)
            ? ((e = i.isClosedStart ? s[s.length - 4] : s[t - 2]),
              ...
              (this._handle1.style.visibility = this._line1.style.visibility =
                X || e !== s[t] || n !== s[t + 1] ? 'visible' : 'hidden'),
              this._handle1.setAttribute('transform', 'translate(' + e + ot + n + ')'),
              this._line1.setAttribute('points', e + ot + n + ot + s[t] + ot + s[t + 1]))
          ...
          i && t < s.length - 2
            ? ((e = s[t + 2]),
              ...
              (this._handle2.style.visibility = this._line2.style.visibility =
                X || e !== s[t] || n !== s[t + 1] ? 'visible' : 'hidden'),
              this._handle2.setAttribute('transform', 'translate(' + e + ot + n + ')'),
              this._line2.setAttribute('points', s[t] + ot + s[t + 1] + ot + e + ot + n))
        ...
        for (s = 0; s < l; s++)
          (i = (o = h[s]).i),
            ...
            i < a.length - 2 &&
              ...
              (a[i + 3] = (((a[i + 3] + n) * c) | 0) / c)),
            o !== t &&
              o.element.setAttribute('transform', 'translate(' + a[i] + ot + a[i + 1] + ')')
        this.update()
      }),
        ...
        if (
          ...
          r &&
            ...
            (e || r.isClosedStart) &&
              ...
              (s = n[1 + a]),
              this._handle1.setAttribute('transform', 'translate(' + i + ot + s + ')'),
              this._line1.setAttribute('points', i + ot + s + ot + n[e] + ot + n[e + 1])),
            e < n.length - 2 &&
              ((i = n[e + 2]),
              (s = n[e + 3]),
              this._handle2.setAttribute('transform', 'translate(' + i + ot + s + ')'),
              this._line2.setAttribute('points', n[e] + ot + n[e + 1] + ot + i + ot + s))),
          t)
        )
          ...
          for (e = 0; e < this._rawPath.length; e++)
            7 < (n = this._rawPath[e]).length &&
              (o += 'M' + n[0] + ot + n[1] + 'C' + n.slice(2).join(ot))
      ...
      (dt.getString = function getString(t, e, n) {
        if (t) {
          ...
          return (function rawPathToString(t) {
            ...
            for (n = 0; n < r; n++) {
              for (
                s = t[n], a += 'M' + o(s[0]) + ',' + o(s[1]) + ' C', e = s.length, i = 2;
                i < e;
                i++
              )
                a +=
      ...
      (dt.getNormalizedSVG = function getNormalizedSVG(t, e, n, i) {
        var s,
          ...
          p = 1 / (c[g - 2] + d),
          f = -t || c[g - 1] + u
        for (f = f ? 1 / f : -p, p *= 1e3, f *= 1e3, a = at.length = 0; a < g; a += 2)
          (at[a] = (((c[a] + d) * p) | 0) / 1e3), (at[a + 1] = (((c[a + 1] + u) * f) | 0) / 1e3)
        if (i) {
          for (s = [], g = at.length, a = 2; a < g; a += 6)
            (o = at[a - 2]),
              (r = at[a - 1]),
              (h = at[a + 4]),
              (l = at[a + 5]),
        ...
        return n && 8 === g && 0 === at[0] && 0 === at[1] && 1 === at[g - 2] && 1 === at[g - 1]
          ? at.slice(2, 6).join(',')
          : ((at[2] = 'C' + at[2]), 'M' + at.join(','))
      }),
      PathEditor)
  function PathEditor(t, e) {
    ;(e = e || {}),
      Y ||
        (function _initCore() {
          ;(L = document),
            ...
            (r = L.body),
            (B = na('div')),
            ((z = na('textarea')).style.display = 'none'),
            r && r.appendChild(z),
            (V = (function (t) {
              for (
                var e = t.split(','),
                  n = (
                    void 0 !== B.onpointerdown
                      ? 'pointerdown,pointermove,pointerup,pointercancel'
                      : void 0 !== B.onmspointerdown
            ...
            Aa(L, 'touchcancel', _),
            Aa(c, 'touchmove', _),
            r && r.addEventListener('touchstart', _),
            (Y = 1)
        })(),
      (this.vars = e),
      (this.path = 'string' == typeof t ? L.querySelectorAll(t)[0] : t),
      (this._g = oa('g', this.path.ownerSVGElement, {class: 'path-editor-g path-editor'})),
      ...
      (this._selection =
        e._selection || oa('g', this._g, {class: 'path-editor-selection path-editor'})),
      ...
      (this._line1 = oa('polyline', this._selection, {
        stroke: Q,
        strokeWidth: 2,
        vectorEffect: 'non-scaling-stroke',
      })),
    ...
    ;(this._squareHandle = (function _getSquarePathData(t) {
      ...
      (this._circleHandle = (function _getCirclePathData(t) {
        var e = ta(0.552284749831 * t)
        return (
          'M' +
          (t = ta(t)) +
          ',0C' +
          [t, e, e, t, 0, t, -e, t, -t, e, -t, 0, -t, -e, -e, -t, 0, -t, e, -t, t, -e, t, 0].join(
            ot
          ) +
          'z'
        )
      })(1.15 * i)),
      (this._handle1 = oa('path', this._selection, {
    ...
    for (
      ...
      s[a]._gsSelection = !0
    !1 !== e.draggable &&
      (this._draggable = new ht(this._selectionHittest, {
        callbackScope: this,
        onPress: this.select,
        onRelease: this._onRelease,
      ...
      !1 !== e.selected && ((this.path._gsSelection = !0), rt.push(this)),
      this._saveState(),
      h ||
        (Aa(this._selectionHittest, 'mousedown', Fa(this._onClickSelectionPath, this)),
        Aa(this._selectionHittest, 'mouseup', Fa(this._onRelease, this))),
      Aa(this._selectionHittest, 'touchstart', Fa(this._onClickSelectionPath, this)),
      Aa(this._selectionHittest, 'touchend', Fa(this._onRelease, this))
  }
  ;(ut.simplifyPoints = simplifyPoints),
    (ut.pointsToSegment = pointsToSegment),
    (ut.simplifySVG = function (t, e) {
      var n, i, s, a, o, r, h, l, c, d, u, g
      if (
        ((d = (e = e || {}).tolerance || 1),
        (c = e.precision || 1 / d),
        (g = (void 0 === e.cornerThreshold ? 18 : +e.cornerThreshold) * J),
        'string' != typeof t && (t = (n = t).getAttribute('d')),
        ('#' !== t.charAt(0) && '.' !== t.charAt(0)) ||
          ((n = L.querySelector(t)) && (t = n.getAttribute('d'))),
        (i = !1 !== e.curved || /[achqstvz]/gi.test(t) ? stringToRawPath(t)[0] : t.match($)),
        !1 !== e.curved)
      ) {
  ...
  function bb(t, e) {
    var n = ft.createElementNS
      ? ft.createElementNS((e || 'http://www.w3.org/1999/xhtml').replace(/^https/, 'http'), t)
      : ft.createElement(t)
    return n.style ? n : ft.createElement(t)
  }
  function hb(t, e, n) {
    return ab(t) && Pt.test(t)
      ? ft.querySelector(t)
      : Array.isArray(t)
      ? yt(bt([{x: gt.getProperty(e, 'x'), y: gt.getProperty(e, 'y')}].concat(t), n))
      : ab(t) || (t && 'path' === (t.tagName + '').toLowerCase())
      ? t
      : 0
  }
  function mb(t, e) {
    ...
    ;(pt = window),
      (gt = gt || t || pt.gsap || console.warn(n)),
      (ft = document),
      (mt = ft.body),
      (_t = ft.documentElement),
      (vt = gt && gt.plugins.motionPath)
        ? ((function _initCopyToClipboard() {
            ;((At = bb('textarea')).style.display = 'none'), mt.appendChild(At)
          })(),
          (bt = vt.arrayToRawPath),
          (yt = vt.rawPathToString))
        : !0 === e && console.warn(n)
  }
  var gt,
    pt,
  ...
  function MotionPathHelper(t, e) {
    ...
    var n,
      ...
      _ = this,
      m = {x: 0, y: 0}
    t instanceof gt.core.Tween
      ? (n = (l = t).targets()[0])
      : ((n = gt.utils.toArray(t)[0]),
      ...
      (a = parseFloat(gt.getProperty(n, 'x', 'px'))),
      (o = parseFloat(gt.getProperty(n, 'y', 'px'))),
      (s = n.getCTM && 'svg' !== n.tagName.toLowerCase()),
      l && !i && (i = hb(l.vars.motionPath.path || l.vars.motionPath, n, l.vars.motionPath)),
      ...
      (f._gsHelper = _),
      (gt.utils.toArray(e.container)[0] || mt).appendChild(f),
      ...
      (h = i && i.ownerSVGElement) ||
        ((c =
          (s && n.ownerSVGElement && n.ownerSVGElement.getAttribute('xmlns')) ||
          'http://www.w3.org/2000/svg'),
        s
          ? ((h = n.ownerSVGElement),
            (d = n.getBBox()),
            (a = (u = (function _getConsolidatedMatrix(t) {
              return (t.transform.baseVal.consolidate() || St).matrix
            })(n)).e),
            (o = u.f),
            (m.x = d.x),
            (m.y = d.y))
      ...
      (this.editor = ut.create(i, e)),
      e.center && gt.set(n, {transformOrigin: '50% 50%', xPercent: -50, yPercent: -50}),
      l
        ? (l.vars.motionPath.path ? (l.vars.motionPath.path = i) : (l.vars.motionPath = {path: i}),
          p.parent !== gt.globalTimeline &&
            gt.globalTimeline.add(
              p,
  ...
  ;(wt.register = mb),
    ...
    (wt.editPath = function (t, e) {
      return ut.create(t, e)
    }),
    (wt.version = '3.7.1'),
    (t.MotionPathHelper = wt),
    (t.default = wt)
