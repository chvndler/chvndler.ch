...
!(function (e, t) {
    ...
    for (t = 0; t < v; t++)
      if (
        ...
        if (
          ...
          (n = 7),
          1 < x.length &&
            (x.length < 3 ? ((c = f), (f = d), n--) : ((c = d), (f = x.substr(2)), (n -= 2)),
            (d = x.charAt(1)),
            (x = x.charAt(0))),
          (l = arcToSegment(
            y,
              ...
              ? ((u.cx = h.x - u.x),
                ...
                u.cx < l &&
                  (u.cx
                    ? (l = u.cx)
                    : ((u.cx = 0.001),
                      r === n - 1 && ((u.x -= 0.001), (l = Math.min(l, 0.001)), (p = 0)))))
              : (g.splice(r--, 1), n--)
      ...
      (CustomEase.getSVGData = function getSVGData(e, t) {
        ...
        if (
          ...
          n = (function rawPathToString(e) {
            ...
            for (n = 0; n < i; n++) {
              for (
                a = e[n], r += 'M' + m(a[0]) + ',' + m(a[1]) + ' C', t = a.length, s = 2;
                s < t;
                s++
              )
                r +=
  ...
  p() && M.registerPlugin(n), (n.version = '3.7.1'), (e.CustomEase = n), (e.default = n)
