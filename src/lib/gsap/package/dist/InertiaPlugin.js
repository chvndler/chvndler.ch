;(function (global, factory) {
  ...
  var gsap$1,
    ...
    _getGSAP$1 = function _getGSAP() {
      return (
        gsap$1 ||
        (typeof window !== 'undefined' && (gsap$1 = window.gsap) && gsap$1.registerPlugin && gsap$1)
      )
    },
    ...
    _calculateTweenDuration = function _calculateTweenDuration(
      target,
      vars,
      maxDuration,
      minDuration,
    ...
    render: function render(ratio, data) {
      ...
      while (pt) {
        pt.set(
          pt.t,
          pt.p,
          _round$1(pt.s + pt.c1 * ratio + pt.c2 * ratio * ratio) + pt.u,
          pt.d,
          ratio
        )
        pt = pt._next
