...
!(function (t, e) {
    ...
    if (p || r) {
      for (
        i = w < b || (L && M < R) || (T && m.t < d.t),
          y(a, b, R, d.t) &&
            (b++, i || (w++, T ? ((m.t = (m.t - d.t) / (1 - d.t)), (M = 0)) : L && (M -= R))),
          1 - (n - e) < 1e-5 ? (w = b - 1) : !m.t && w ? w-- : y(a, w, M, m.t) && i && b++,
  ...
  function measureSegment(t, e, n) {
    ...
    if (T.length && N) {
      if (((t.totalLength = y = T[T.length - 1] || 0), y / (t.minLength = N) < 9999))
        for (x = v = 0, r = 0; r < y; r += N) S[x++] = T[v] < r ? ++v : v
    ...
    if (e)
      if (1 === e) (u = 1), (h = (f = t[(g = t.length - 1)]).length - 8)
        ...
        ;(a = f.samples),
          (o = f.resolution),
          (i = f.totalLength * e),
          (s = (h = f.lookup.length ? f.lookup[~~(i / f.minLength)] || 0 : m(a, i, e))
            ? a[h - 1]
            : 0),
          (l = a[h]) < i && ((s = l), (l = a[++h])),
          (u = (1 / o) * ((i - s) / (l - s) + (h % o))),
  ...
  function getPositionOnPath(t, e, n, r) {
    ...
    return (
      ...
      (i = c.totalLength * e),
      (s = (h = c.lookup.length
        ? c.lookup[e < 1 ? ~~(i / c.minLength) : c.lookup.length - 1] || 0
        : m(a, i, e))
        ? a[h - 1]
        : 0),
      (l = a[h]) < i && ((s = l), (l = a[++h])),
      ...
      (g = c[(h = 6 * ~~(h / o))]),
      (p.x = B(
        (u * u * (c[h + 6] - g) + 3 * f * (u * (c[h + 4] - g) + f * (c[h + 2] - g))) * u + g
      )),
      (p.y = B(
        (u * u * (c[h + 7] - (g = c[h + 1])) + 3 * f * (u * (c[h + 5] - g) + f * (c[h + 3] - g))) *
          u +
          g
      )),
      n &&
  ...
  function arcToSegment(t, e, n, r, a, o, i, s, l) {
    if (t !== s || e !== l) {
      ...
      for (G = 0; G < X.length; G += 2)
        (m = X[G]), (v = X[G + 1]), (X[G] = m * Z + v * Y + S), (X[G + 1] = m * V + v * j + N)
  ...
  function stringToRawPath(t) {
    ...
    for (e = 0; e < P; e++)
      if (
        ...
        (u = x),
          (g = y),
          ('C' !== c && 'S' !== c) || ((u += x - s[s.length - 4]), (g += y - s[s.length - 3])),
          i || (x = y = 0),
        ...
        if (
          ...
          (n = 7),
          1 < p.length &&
            (p.length < 3 ? ((g = u), (u = d), n--) : ((g = d), (u = p.substr(2)), (n -= 2)),
            (d = p.charAt(1)),
            (p = p.charAt(0))),
          (f = arcToSegment(
            x,
          ...
          (x === r && y === a) ||
            (n < o
              ...
              : ((i = S(u, l)),
                ...
                (i = S(R, M)),
                b.push(B(x), B(y), B(x + U(i) * c), B(y + F(i) * c)))))
    return (
      x !== P || y !== w || b.length < 4 ? b.push(B(P), B(w), B(P), B(w)) : (b.length -= 2),
  ...
  function rawPathToString(t) {
    ...
    var e,
      ...
      i = t.length
    for (n = 0; n < i; n++) {
      for (a = t[n], o += 'M' + B(a[0]) + ',' + B(a[1]) + ' C', e = a.length, r = 2; r < e; r++)
        o +=
          B(a[r++]) +
          ',' +
          B(a[r++]) +
  ...
  function R(t) {
    ...
    if (((v = window), (E = new j()), e)) {
      ;(P = (c = e).documentElement),
        (w = e.body),
        ((G = c.createElementNS('http://www.w3.org/2000/svg', 'g')).style.transform = 'none')
            ...
            -(a = (function _getCTM(t) {
              ...
              return (
                n ||
                  ...
                  e
                    ? (t.style[z] = e)
                    : t.style.removeProperty(z.replace(/([A-Z])/g, '-$1').toLowerCase())),
                n
              )
            })(t)).e / a.a),
          (i = -a.f / a.d),
            ...
            (r = (r = t.transform ? t.transform.baseVal : {}).numberOfItems
              ? 1 < r.numberOfItems
                ? (function _consolidate(t) {
                    for (var e = new j(), n = 0; n < t.numberOfItems; n++)
  ...
  function oa(t, e, n, r, a, o, i, s, l) {
    return (
      (e =
        'cubic' === i.type
          ? [e]
          : (!1 !== i.fromCurrent && e.unshift(ma(n, r, s), a ? ma(n, a, l) : 0),
            i.relative && na(e),
  ...
  function ra(t, e, n) {
    ...
    return (
      ...
      e &&
        'auto' !== e &&
        ((a += e.push ? e[0] * (r ? r.width : t.offsetWidth || 0) : e.x),
  ...
  function sa(t, e, n, r) {
    ...
    return (
      ...
      'auto' === r &&
        ...
        (u += a.y)),
      (a || (e.getBBox && t.getBBox && e.ownerSVGElement === t.ownerSVGElement)) &&
      ...
      return t && t.length
        ? (i &&
            ('self' === i || (r = J(i)[0] || e) === e
              ...
              : (u && !1 !== u[2]
                  ? Q.set(e, {transformOrigin: 100 * u[0] + '% ' + 100 * u[1] + '%'})
    ...
    a = {
      ...
      init: function init(t, e) {
        ...
        if (
          ...
          cacheRawPathMeasurements((n = f(nt(getRawPath(e.path), t, e))), e.resolution),
            a.push(n),
          ...
          for (r in (h && u
            ...
            : (h = u = 0),
          g))
            r !== h && r !== u && a.push(oa(this, la([], o, r, 2), t, r, 0, f, e, W(o[0][r])))
        }
      },
      render: function render(t, e) {
        ...
        e.rotate &&
          e.rSet(e.target, e.rProp, n[0].angle * (e.radians ? o : 1) + e.rOffset + e.ru, e, t)
      },
