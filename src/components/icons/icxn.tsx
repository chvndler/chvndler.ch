...
export type IcxnVariant = 'C Logo' | 'Project' | 'Twitter' | 'GitHub' | 'X';
  ...
  if (variant === 'X') {
    return (
      <>
        ...
        >
          <path
            d="M15.7,13.9h-5l-2.7-3l-2.6,3h-5L5.5,8L0.3,2.1h4.9L8,5.3l2.8-3.2h4.9L10.5,8L15.7,13.9z M10.8,13.5h4L10,8.1l4.8-5.5H11
		L8,5.9L5,2.5H1.2l4.9,5.5l-4.9,5.4h4L8,10.3L10.8,13.5z"
          />
        </svg>
      </>
    );
