  ...
  <footer className='relative w-full px-3'>
    <div className='mx-auto mt-3 flex max-w-[620px] items-end pb-6 pt-3 text-center'>
      <div className='flex flex-col items-start justify-start my-auto gap-y-1'>
        ...
        <span className='text-left font-fraktion text-[13px] font-[680] uppercase leading-4 tracking-wide text-carbon-500 dark:text-carbon-400'>
          <AriePosition />
        </span>
        <span className='text-left font-fraktion text-[13px] font-[680] uppercase leading-4 tracking-wide text-carbon-500 dark:text-carbon-400'>
      ...
      <div className='grow text-right font-archivo text-[13px] font-semibold text-carbon-500 hover:text-carbon-700 dark:text-carbon-400 dark:hover:text-carbon-600'>
