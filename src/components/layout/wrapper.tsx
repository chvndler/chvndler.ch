...
export const AppWrapper = ({ children }: { children: React.ReactNode }) => {
  return (
    <div
      ...
      <div
        id='wrap-two'
        className={cn(`wrap-layer2 flex-1 px-3`)}>
        <div
          id='wrap-one'
...
export const AppLiner = ({ children }: { children: React.ReactNode }) => {
  return (
    <section className={cn(`m-0 h-screen min-h-screen overflow-hidden p-0`)}>
      {children}
    </section>
  );
};
...
export const ComponentContainer = ({
  ...
  return (
    <>
      <section
        id='comp-contain'
        className='my-18 m-auto w-full border border-carbon-800 p-2'>
        {children}
      </section>
    </>
  );
