  ...
  const listItems = sortedProjects.map((project, i) => (
    <li
      ...
      <div key={i} className='m-auto flex w-full flex-row items-center justify-between'>
        <Link
          href={project.url}
          className='text-md items-center justify-start py-2 font-ibmSans font-medium lowercase tracking-tight text-carbon-500 hover:text-carbon-700 dark:hover:text-carbon-300 md:text-lg'>
          {project.title}
        </Link>
