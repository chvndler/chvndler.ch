...
const MinimalProjectCard = styled(Card, {
  display: 'flex',
  flexDirection: 'column',
  boxSizing: 'border-box',
  width: 'auto',
...
const MinimalProjectSummary = styled('p', {
  fontFamily: '$lateralStandard',
  fontWeight: 'normal',
  fontSize: 15,
  color: '$sage9',
...
const MinimalProjectTitle = styled('h3', {
  fontSize: 24,
  fontFamily: '"Lateral Extended Bold", sans-serif',
  fontWeight: 'bold',
  color: '$chxn4'
...
export const MinimalProjectEntry = ({ pTitle, pRepository, pSummary }: PProps) => {
  return (
    <MinimalProjectCard css={{ userSelect: 'none' }}>
      <Box css={{ position: 'absolute', bottom: 6, padding: 28 }}>
        <MinimalProjectTitle>{pTitle}</MinimalProjectTitle>
        <Space size={'1'} />
        <MinimalProjectSummary>{pSummary}</MinimalProjectSummary>
        <Space size={'2'} />
        <Button
          target="_blank"
          rel="norefferer"
