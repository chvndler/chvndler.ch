    ...
    <div
      ...
      {isHovered ? (
        <HoverableTextElement
          className={clsx('font-[600] text-azure dark:text-azure')}
          text={hoverText}
        />
      ) : (
        <HoverableTextElement
          className={clsx('font-[600] text-charcoal dark:text-carbon-50')}
          text={defaultText}
        />
      )}
    </div>
...
export const HoverableTextElement = ({
  ...
  return (
    <p
      className={clsx(
        'cursor-pointer font-favorit text-[16px] leading-4 transition-all duration-150',
        className,
      )}>
      {text}
    </p>
