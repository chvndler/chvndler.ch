...
const ContentSecurityPolicy = `
    ...
    img-src * blob: data: imagedelivery.net chvn.me;
    media-src data: *.scdn.co stream.mux imagedelivery.net chvn.me;
    connect-src data: * stream.mux market-assets.fra1.cdn.digitaloceanspaces.com imagedelivery.net;
    font-src 'self';
`
